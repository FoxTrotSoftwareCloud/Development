...
<table class="table table-bordered table-stripped table-hover">
    ...
    <?php foreach($get_notes as $key=>$val){
        ...
        <tr>
            ...
            <form method="post" id="add_client_notes_<?php echo $notes_id;?>" name="add_client_notes_<?php echo $notes_id;?>" onsubmit="return notessubmit(<?php echo $notes_id;?>);" >
                <input type="text" name="client_note" class="form-control" id="client_note" value="<?php echo $val['notes'];?>" style="pointer-events: none;background-color:#ececec ;" />
                <input type="hidden" name="notes_id" id="notes_id" value="<?php echo $notes_id;?>"/>
                <input type="hidden" name="add_notes" value="Add Notes"  />&nbsp;&nbsp;&nbsp;&nbsp;
	             <button type="submit" style="display:none" class="btn btn-sm btn-warning" name="add_notes_btn" value="Add Notes"><i class="fa fa-save"></i> Save</button> 
                <a href="#" onclick="openedit(<?php echo $notes_id;?>);" class="btn btn-sm btn-primary edit-btn" name="edit-btn"><i class="fa fa-edit"></i> Edit</a>
    ...
    <tr id="add_row_notes" style="display: none;">
            ...
            <form method="post" id="add_client_notes_<?php echo $notes_id;?>" name="add_client_notes_<?php echo $notes_id;?>" onsubmit="return notessubmit(<?php echo $notes_id;?>);">
                ...
                <input type="hidden" name="add_notes" value="Add Notes" />&nbsp;&nbsp;&nbsp;&nbsp;
	            <button type="submit" class="btn btn-sm btn-warning" name="add_notes_btn" value="Add Notes"><i class="fa fa-save"></i> Save</button>
            </form>
            </td>
     </tr>
  </tbody>
