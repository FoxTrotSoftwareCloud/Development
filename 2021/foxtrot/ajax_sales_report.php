...
?>
        <table border="0" width="100%">
            <tr>
                ...
                <td width="60%" align="center"><?php echo $img; ?> <br />
                    <strong>
                        <h5>YEAR-TO-DATE EARNINGS REPORT </h5>
                        <h6>Year <?php echo $report_year . ', ' . $heading; ?></h6>
                </td>
        ...
        <table border="0" cellpadding="1" width="100%">
            ...
            <tbody>
                ...
                ?>
                            <tr>
                                <td style="text-align:left;font-weight:bold;">
                                    <h5><?php echo $trans_data['broker_lastname'] . ', ' . $trans_data['broker_firstname']; ?> </h5>
                                </td>

                                <td style="text-align:left;font-weight:bold;width:10%;">
                                    <h5><?php echo $trans_data['clearing_number']; ?> </h5>
                                </td>

                                <td style="text-align:right;font-weight:bold;">
                                    <h5><?php echo '$' . number_format($gross_earning, 2); ?></h5>
                                </td>
                                <td style="text-align:right;font-weight:bold;">
                                    <h5><?php echo '$' . number_format($net_commission, 2); ?></h5>
                                </td>
                                <td style="text-align:right;font-weight:bold;">
                                    <h5><?php echo '$' . number_format($check_amount, 2); ?></h5>
                                </td>
                                <td style="text-align:right;font-weight:bold;">
                                    <h5><?php echo '$' . number_format($earning_1099, 2); ?></h5>
                                </td>
                            </tr>
                    <?php
                        }
    ...
    elseif ($report_for == "monthly_broker_production") :
        ...
        if (!empty($rows) && !empty($rows['unique_category'])) {
            ...
            echo '<table border="0" cellpadding="1" width="100%">';
            echo "<center><h4><b>Category Total</b></h4></center>";
            echo '<thead class="modal-heading-row">
                         <tr style="vertical-align: bottom;">
                            <td align="right">Product Category</td>
                            <td align="right">Toatal Investment Amount</td>
                            <td align="right">Total Commission Received </td>
                            <td align="right">Total Net Commission </td>
                        </tr>
                        </thead>';
            echo '<tbody>';
            foreach ($rows['unique_category'] as $cat) {
                echo '<tr> 
                        <td align="right"><b>' . $cat['product_cat_name'] . '</b></td>
                        <td align="right">' . number_format($cat['total_investment'], 2) . '</td>
                        <td align="right">' . number_format($cat['total_commission_received'], 2) . '</td>
                        <td align="right">' . number_format($cat['net_commission'], 2) . '</td>
                    </tr>';
            }
            echo '</tbody>';
            echo '</table>';
    ...
    ?>
        <table border="0" width="100%">
            <tr>
                ...
                <td width="60%" align="center"><?php echo $img; ?><br />
                    <strong>
                        <h5><?php echo $subheading; ?></h6>
                            <h6><?php echo $companyhead; ?><br /><?php echo $subheading2; ?><br /><?php echo $subheading1; ?><br />
                                <?php if ($broker > 0) {
                                    echo "Broker: " . $instance_trans->get_brokername_by_id($broker);
                                } ?>
                            </h6>
                        ...
                        ?>
                            <?php if ($report_for != "Product Category Summary Report") : ?>
                                <tr>
                                    ...
                                    <?php if ($report_for == "Production by Sponsor Report" || $report_for == "Production by Product Category") : ?>
