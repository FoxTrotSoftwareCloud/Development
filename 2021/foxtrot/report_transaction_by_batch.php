        ...
        foreach ($get_trans_data as $trans_main_key => $trans_main) {
            ...
            foreach ($trans_main["child"] as $trans_main_key => $trans_main_data) {
                ...
                foreach ($trans_main_data as $trans_key => $trans_data) {
                    ...
                    if ($trans_data['trade_date'] != '0000-00-00') {
                        $trade_date = date('m/d/Y', strtotime($trans_data['trade_date']));
                    }

                    if ($trans_data['commission_received_date'] != '0000-00-00') {
                        $commission_received_date = date('m/d/Y', strtotime($trans_data['commission_received_date']));
                    }
