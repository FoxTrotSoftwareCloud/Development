        ...
        $prod_cat = isset($_POST['prod_cat'])?$_POST['prod_cat']:array();
            ...
            {  
                if($report_for == 'broker'){
                 ...
                 header("location:".SITE_URL."sales_reporting_print.php?open=output_print&filter=".$data_array);exit;
                }
            }
            else if($output == 3){
                 if($report_for == 'broker'){
                     ...
                     header("location:".SITE_URL."sales_reporting_excel.php?filter=".$data_array);exit;
                 }
                 ...
                 if($report_for == 'broker'){
                  header("location:".SITE_URL."sales_broker_report_print.php?filter=".$data_array);exit;
                        ...
                        header("location:".SITE_URL."sales_reporting_print.php?filter=".$data_array);exit;
                 }
            }
