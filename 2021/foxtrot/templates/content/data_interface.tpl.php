                ...
                <form name="frm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12" style="background-color: #E9EEF2 !important;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input type="checkbox" name="trade_activity" value="1" onclick="chk_all_class(this.checked)" <?php if ($trade_activity > 0) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input type="checkbox" name="add_client" value="1" onclick="chk_all_class(this.checked)" <?php if ($add_client > 0) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> class="checkbox" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input type="checkbox" name="update_client" value="1" onclick="chk_all_class(this.checked)" <?php if ($update_client > 0) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> class="checkbox" />
                            </div>
                        </div>
                ...
                <form name="frm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input type="checkbox" name="trade_activity" onclick="chk_all_class(this.checked)" value="1" <?php if ($trade_activity > 0) {
                                                                                                                                    echo "checked='checked'";
                                                                                                                                } ?> class="checkbox" />
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input type="checkbox" name="add_client" onclick="chk_all_class(this.checked)" value="1" <?php if ($add_client > 0) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> class="checkbox" />
                            </div>
                        </div>
