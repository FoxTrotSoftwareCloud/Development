            ...
            <div class="panel-overlay-wrap">
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><i class="fa fa-pencil-square-o"></i> <?php echo $action == 'add_new' ? 'Add' : 'Edit'; ?> Payroll Adjustment Category</h3>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $editLink ?>'" style="cursor:pointer"><?php echo $val['type']; ?></td>
                                    <td class="text-center">
                                        <?php
                                        if ($val['status'] == 1) {
                                        ?>
