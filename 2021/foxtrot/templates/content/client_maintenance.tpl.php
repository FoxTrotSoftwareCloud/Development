...
<script>
    function addMoreDocs() {
        var html = '<div class="row">' +
            ...
            <?php foreach ($get_sponsor as $key => $val) { ?> '<option value="<?php echo $val['id']; ?>" <?php if ($sponsor_company != '' && $sponsor_company == $val['id']) {
                                                                                                                echo "selected";
            ...
            <div class="tab-pane active" id="tab_a">
                ...
                ?>
                    <ul class="nav nav-tabs <?php /*if($action=='add_new'||($action=='edit' && $id>0)){ echo 'topfixedtabs';}*/ ?>">
                        <li class="<?php if (isset($_GET['tab']) && $_GET['tab'] == "primary") {
                                        echo "active";
                                    } else if (!isset($_GET['tab'])) {
                                        echo "active";
                                    } else {
                                        echo '';
                                    } ?>"><a href="#tab_aa" data-toggle="tab">Primary</a></li>
                        <li class="<?php if (isset($_GET['tab']) && $_GET['tab'] == "account_no") {
                                        echo "active";
                                    } ?>"><a href="#tab_dd" data-toggle="tab">Account No's</a></li>
                        <li class="<?php if (isset($_GET['tab']) && $_GET['tab'] == "employment") {
                                        echo "active";
                                    } ?>"><a href="#tab_bb" data-toggle="tab">Employment</a></li>
                        <li class="<?php if (isset($_GET['tab']) && $_GET['tab'] == "suitability") {
                                        echo "active";
                                    } ?>"><a href="#tab_ff" data-toggle="tab">Suitability</a></li>
                        <li class="<?php if (isset($_GET['tab']) && $_GET['tab'] == "objectives") {
                                        echo "active";
                    ...
                    <form method="post">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "primary") {
                                                        echo "active";
                                                    } else if (!isset($_GET['tab'])) {
                                                        echo "active";
                                                    } else {
                                ...
                                <div class="panel-overlay-wrap">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h4 class="panel-title" style="font-size: 20px;"><input type="checkbox" class="checkbox" name="do_not_contact" value="1" id="do_not_contact" style="display: inline !important;" <?php if ($do_not_contact > 0) {
                                                                                                                                                                                                                                            echo "checked='checked'";
                                                                                                                                                                                                                                        } ?> /> Do Not Contact&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="1" name="active" id="active" class="checkbox" style="display: inline !important;" <?php if ($active > 0) {
                                                                                                                                                                                                                                                                                                                                                                                                                echo "checked='checked'";
                                                                                                                                                                                                                                                                                                                                                                                                            } ?> /> Active</h4>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="reviewed">
                                                        <div class="check-review">
                                                            Reviewed
                                                            <input type="checkbox" name="is_reviewed" value="<?php echo !empty($reviewed_at) ? $reviewed_at : '';  ?>" id="is_reviewed" <?php if ($is_reviewed > 0) {
                                                                                                                                                                                            echo "checked='checked'";
                                                                                                                                                                                        } ?>>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="account_type" id="account_type" class="form-control">
                                                            ...
                                                            <?php foreach ($get_account_type as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($account_type != '' && $account_type == $val['id']) {
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="split_broker" id="split_broker" class="form-control">
                                                            <option value="">Select Broker</option>
                                                            <?php foreach ($get_broker as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($split_broker != '' && $split_broker == $val['id']) {
                                                                                                                echo "selected";
                                                                                                            } ?>><?php echo strtoupper($val['last_name'] . (($val['last_name'] != "" and $val['first_name'] != "") ? ", " : "") . $val['first_name']); ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="state" id="state" class="form-control">
                                                            ...
                                                            <?php foreach ($get_state as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($state != '' && $state == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="contact_status" id="contact_status" class="form-control">
                                                            ...
                                                            <option value="1" <?php if ($contact_status != '' && $contact_status == 1) {
                                                                                    echo "selected='selected'";
                                                                                } ?>>Yes</option>
                                                            <option value="2" <?php if ($contact_status != '' && $contact_status == 2) {
                                                                                    echo "selected='selected'";
                                                                                } ?>>No</option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" name="birth_date" onchange="getAge(this.value);" id="birth_date" class="form-control" value="<?php if ($birth_date != '') {
                                                                                                                                                                                    echo date('m/d/Y', strtotime($birth_date));
                                                                                                                                                                                } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="date_established1" id="date_established1" disabled="true" value="<?php if ($date_established != '') {
                                                                                                                                                        echo date('m/d/Y', strtotime($date_established));
                                                                                                                                                    } else {
                                                                                                                                                        if ($action == 'add_new') {
                                                                                                                                                            echo date("m/d/Y");
                                                                                                                                                        }
                                                                                                                                                    } ?>" class="form-control" />
                                                        <input type="hidden" name="date_established" id="date_established" value="<?php if ($date_established != '') {
                                                                                                                                        echo $date_established;
                                                                                                                                    } else {
                                                                                                                                        if ($action == 'add_new') {
                                                                                                                                            echo date("m/d/Y");
                                                                                                                                        }
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" name="open_date" id="open_date" class="form-control" value="<?php if ($open_date != '') {
                                                                                                                                                    echo date('m/d/Y', strtotime($open_date));
                                                                                                                                                } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" data-required="true" name="naf_date" id="naf_date" class="form-control" value="<?php if ($naf_date != '') {
                                                                                                                                                                        echo date('m/d/Y', strtotime($naf_date));
                                                                                                                                                                    } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" name="last_contacted" id="last_contacted" class="form-control" value="<?php if ($last_contacted != '') {
                                                                                                                                                                echo date('m/d/Y', strtotime($last_contacted));
                                                                                                                                                            } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <!-- Tab 1 is ends -->
                            <div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "employment") {
                                                        echo "active";
                                                    } ?>" id="tab_bb">
                                <div class="panel-overlay-wrap">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <h4 class="panel-title" style="font-size: 20px;">
                                                <?php if (isset($_SESSION['client_full_name'])) {
                                                    echo $_SESSION['client_full_name'];
                                                } ?></h4>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" name="security_related_firm" id="security_related_firm" class="checkbox" value="1" <?php if ($security_related_firm > 0) {
                                                                                                                                                                        echo "checked='checked'";
                                                                                                                                                                    } ?> />
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" name="finra_affiliation" id="finra_affiliation" class="checkbox" value="1" <?php if ($finra_affiliation > 0) {
                                                                                                                                                                echo "checked='checked'";
                                                                                                                                                            } ?> />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="radio" onclick="close_other()" name="options" id="options" class="radio" style="display: inline;" value="1" <?php if ($options == 1) {
                                                                                                                                                                                        echo "checked='checked'";
                                                                                                                                                                                    } ?> />&nbsp;<label>Driver License</label>&nbsp;&nbsp;
                                                        <input type="radio" onclick="close_other()" name="options" id="options" class="radio" style="display: inline;" value="2" <?php if ($options == 2) {
                                                                                                                                                                                        echo "checked='checked'";
                                                                                                                                                                                    } ?> />&nbsp;<label>Passport</label>&nbsp;&nbsp;
                                                        <input type="radio" onclick="open_other()" name="options" id="options" class="radio" style="display: inline;" value="3" <?php if ($options == 3) {
                                                                                                                                                                                    echo "checked='checked'";
                                                                                                                                                                                } ?> />&nbsp;<label>Other</label>&nbsp;
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" name="expiration" id="expiration" class="form-control" value="<?php if ($expiration != '') {
                                                                                                                                                        echo date('m/d/Y', strtotime($expiration));
                                                                                                                                                    } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="state_employe" id="state_employe" class="form-control">
                                                            <option value="">Select State</option>
                                                            <?php foreach ($get_state as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($state_employe != '' && $state_employe == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" name="date_verified" id="date_verified" class="form-control" value="<?php if ($date_verified != '') {
                                                                                                                                                            echo date('m/d/Y', strtotime($date_verified));
                                                                                                                                                        } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "objectives") {
                                                        echo "active";
                                                    } ?>" id="tab_cc">
                                <div class="panel-overlay-wrap">
                                    <div class="panel">
                                        <div id="message"></div>
                                        <div class="panel-heading">
                                            <h4 class="panel-title" style="font-size: 20px;"><?php if (isset($_SESSION['client_full_name'])) {
                                                                                                    echo $_SESSION['client_full_name'];
                                                                                                } ?></h4>
                                        </div>
                                        <div class="panel-body">
                            ...
                            <div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "account_no") {
                                                        echo "active";
                                                    } ?>" id="tab_dd">
                            ...
                            <div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "suitability") {
                                                        echo "active";
                                                    } ?>" id="tab_ff">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="goal_horizone" id="goal_horizone" class="form-control">
                                                            ...
                                                            <?php foreach ($get_horizon as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($goal_horizone != '' && $goal_horizone == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="net_worth" id="net_worth" class="form-control">
                                                            <?php foreach ($get_networth as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($net_worth != '' && $net_worth == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="risk_tolerance" id="risk_tolerance" class="form-control">
                                                            ...
                                                            <?php foreach ($get_risk_tolerance as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($risk_tolerance != '' && $risk_tolerance == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="annual_expenses" id="annual_expenses" class="form-control">
                                                            ...
                                                            <?php foreach ($get_annual_expenses as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($annual_expenses != '' && $annual_expenses == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="liquidity_needs" id="liquidity_needs" class="form-control">
                                                            ...
                                                            <?php foreach ($get_liqudity_needs as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($liquidity_needs != '' && $liquidity_needs == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="liquid_net_worth" id="liquid_net_worth" class="form-control">
                                                            <?php foreach ($get_liquid_net_worth as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($liquid_net_worth != '' && $liquid_net_worth == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="special_expenses" id="special_expenses" class="form-control">
                                                            ...
                                                            <?php foreach ($get_special_expenses as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($special_expenses != '' && $special_expenses == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="per_of_portfolio" id="per_of_portfolio" class="form-control">
                                                            ...
                                                            <?php foreach ($get_portfolio as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($per_of_portfolio != '' && $per_of_portfolio == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="timeframe_for_special_exp" id="timeframe_for_special_exp" class="form-control">
                                                            ...
                                                            <?php foreach ($get_time_for_exp as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($timeframe_for_special_exp != '' && $timeframe_for_special_exp == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="account_use" id="account_use" class="form-control">
                                                            ...
                                                            <?php foreach ($get_account_use as $key => $val) { ?>
                                                                <option value="<?php echo $val['id']; ?>" <?php if ($account_use != '' && $account_use == $val['id']) {
                                                                                                                echo "selected='selected'";
                                                                                                            } ?>><?php echo $val['option']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="demo-dp-range">
                                                            <div class="input-daterange input-group" id="datepicker">
                                                                <input type="text" name="sign_date" id="sign_date" value="<?php if ($sign_date != '') {
                                                                                                                                echo date('m/d/Y', strtotime($sign_date));
                                                                                                                            } ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="table-responsive" id="table-scroll" style="margin: 0px 5px 0px 5px;">
                                    <table class="table table-bordered table-stripped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $lable_array = array();
                                            $lable_array = array(
                                                'first_name' => 'First Name', 'mi' => 'MI', 'last_name' => 'Last Name
            ', 'do_not_contact' => 'Do Not Contact', 'active' => 'Active', 'ofac_check' => 'OFAC Check', 'fincen_check' => 'FinCEN Check', 'long_name' => 'Long Name', 'client_file_number' => 'Client File Number', 'clearing_account' => 'Clearing Acct', 'client_ssn' => 'Client SSN', 'house_hold' => 'Household', 'split_broker' => 'Split Broker', 'split_rate' => 'Split Rate', 'address1' => 'Address1', 'address2' => 'Address2', 'city' => 'City', 'state' => 'State', 'zip_code' => 'Zip Code', 'citizenship' => 'Citizenship', 'birth_date' => 'Birth Date', 'age' => 'Age', 'date_established' => 'Date Established', 'open_date' => 'Open Date', 'naf_date' => 'NAF Date', 'last_contacted' => 'Last Contacted', 'account_type' => 'Account Type', 'broker_name' => 'Broker', 'telephone' => 'Telephone', 'contact_status' => 'Contact Status',
                                            ...
                                            foreach ($client_change_data as $key => $val) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } else if ($feild_name == 'Do Not Contact' && $val['old_value'] == 1) { ?>
                                                        <td><?php echo 'Checked'; ?></td>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                    ...
                                                    <?php } else if ($feild_name == 'State') {
                                                        ...
                                                        <td><?php echo $state_name['state_name']; ?></td>
                                                    <?php } else if ($feild_name == 'Account Type') {
                                                    ...
                                                    <?php } else if ($feild_name == 'Broker') {
                                                        ...
                                                        <td><?php echo $broker_name['broker_name']; ?></td>
                                                    <?php } else if ($feild_name == 'Split Broker') {
                                                        $broker_name = $instance->get_broker_name($val['old_value']); ?>
                                                        <td><?php echo $broker_name['broker_name']; ?></td>
                                                        <?php $broker_name = $instance->get_broker_name($val['new_value']); ?>
                                                        <td><?php echo $broker_name['broker_name']; ?></td>
                                                    <?php } else if ($feild_name == 'Contact Status') { ?>
                                                        <td>
                                                            <?php
                                                            if ($val['old_value'] == 1) {
                                                                echo 'Yes';
                                                    ...
                                                    <?php } else if ($feild_name == 'Securities-Related Firm' && $val['old_value'] == 0) { ?>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                        <td><?php echo 'Checked'; ?></td>
                                                    <?php } else if ($feild_name == 'Securities-Related Firm' && $val['old_value'] == 1) { ?>
                                                        <td><?php echo 'Checked'; ?></td>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                    <?php } else if ($feild_name == 'FINRA Affiliation' && $val['old_value'] == 0) { ?>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                        <td><?php echo 'Checked'; ?></td>
                                                    <?php } else if ($feild_name == 'FINRA Affiliation' && $val['old_value'] == 1) { ?>
                                                        <td><?php echo 'Checked'; ?></td>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                    <?php } else if ($feild_name == 'CIP Options') { ?>
                                                        <td>
                                                            <?php
                                                            if ($val['old_value'] == 1) {
                                                                echo 'Driver License';
                                                    ...
                                                    <?php } else if ($feild_name == 'Goal Horizon') {
                                                        ...
                                                        <td><?php echo $goal_name['goal']; ?></td>
                                                    <?php } else if ($feild_name == 'Net Worth') {
                                                        ...
                                                        <td><?php echo $net_worth_name['net_worth']; ?></td>
                                                    <?php } else if ($feild_name == 'Risk Tolerance') {
                                                        ...
                                                        <td><?php echo $risk_tolerance_name['risk']; ?></td>
                                                    <?php } else if ($feild_name == 'Annual Expenses') {
                                                        ...
                                                        <td><?php echo $annual_exp_name['annual_expense']; ?></td>
                                                    <?php } else if ($feild_name == 'Liquidity Needs') {
                                                        ...
                                                        <td><?php echo $liquid_need['liquidity_needs']; ?></td>
                                                    <?php } else if ($feild_name == 'Liquid Net Worth') {
                                                        ...
                                                        <td><?php echo $liquid_net_worth_name['liquid_net_worth']; ?></td>
                                                    <?php } else if ($feild_name == 'Special Expenses') {
                                                        ...
                                                        <td><?php echo $spc_exp_name['special_expense']; ?></td>
                                                    <?php } else if ($feild_name == '% of Portfolio') {
                                                        ...
                                                        <td><?php echo $per_port_name['per_of_portfolio']; ?></td>
                                                    <?php } else if ($feild_name == 'Timeframe for Special Exp') {
                                                        ...
                                                        <td><?php echo $time_frm_name['time_frame']; ?></td>
                                                    <?php } else if ($feild_name == 'Account Use') {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#data-table-list_filter [type='search']").focus();
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#objectives").multiSelect({
            selectableHeader: '<h4 class="panel-title" style="font-size: 20px;">Source Objectives <i class="fa fa-angle-double-right"></i> <span class="text-red">*</span></h4>',
            selectionHeader: '<h4 class="panel-title" style="font-size: 20px;"><i class="fa fa-angle-double-left"></i> Selected Objectives </h4>',
            cssClass: "objectives-wrap"
        });
    });
    $(document).ready(function() {
...
<script>
    function send_allobjectives() {
        ...
        var values = $("input[name='allobjectives[]']").map(function() {
            return $(this).val();
        }).get();
...
<script>
    function changeHandler(val) { //alert(parseFloat(val.toFixed(2)));
