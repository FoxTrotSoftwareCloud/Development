...
<script>
    ...
    function add_override() {
        ...
        var html = '<tr class="tr">' +
            ...
            <?php foreach ($get_broker as $key => $val) { ?> "<option value='<?php echo $val['id'] ?>'><?php echo $val['first_name'] . ' ' . $val['last_name'] ?></option>" +
            <?php } ?> '</select>' +
            '</td>' +
            '<td>' +
...
<div id="new_transcation_wrap" class="container">
    ...
    <div class="col-lg-12 well <?php /*if($action=='add'||($action=='edit_transaction' && $id>0)){ echo 'fixedwell';}*/ ?>">
            ...
            <form name="frm2" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="inputpopup">
                                    ...
                                    <input type="text" name="ch_no" id="ch_no" value="<?php if (isset($ch_no)) {
                                                                                            echo $ch_no;
                                ...
                                <div class="inputpopup">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">$</span>
                                        <input type="text" name="ch_amount" onChange="setnumber_format(this)" value="<?php if (isset($ch_amount)) {
                                                                                                                            echo $ch_amount;
                                                                                                                        } ?>" id="ch_amount" class="form-control two-decimals required" />
                                    </div>
                                </div>
                                <div class="inputpopup">
                                    ...
                                    <div id="demo-dp-range">
                                        <div class="input-daterange input-group" style="width:auto !important;" id="datepicker">
                                            <input type="text" name="ch_date" id="ch_date" value="<?php if (isset($ch_date) && $ch_date != '0000-00-00' && $ch_date != '') {
                                                                                                        echo date('m/d/Y', strtotime($ch_date));
                                                                                                    } ?>" class="form-control required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="inputpopup">
                                    ...
                                    <input type="text" name="ch_pay_to" maxlength="40" value="<?php if (isset($ch_pay_to)) {
                                                                                                    echo $ch_pay_to;
                                                                                                } ?>" id="ch_pay_to" class="form-control required" />
                                </div>
                                <div class="col-md-12">
                                    <div id="msg">
                                    </div>
                ...
                <div class="panel">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" disabled="true" name="is_pending_order" <?php if (isset($is_pending_order) && $is_pending_order == 1) {
                                                                                            echo 'checked="true"';
                                                                                        } ?> id="is_pending_order" style="display: inline;" value="1" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="trade_number" id="trade_number" value="<?php if (!empty($trade_number)) {
                                                                                                        echo $trade_number;
                                                                                                    } else if (!empty($id)) {
                                                                                                        echo $id;
                                                                                                    } else {
                                                                                                        echo 'Assigned after saving';
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div id="demo-dp-range">
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" autocomplete="off" name="settlement_date" id="settlement_date" value="<?php if (isset($settlement_date) && $settlement_date != '0000-00-00') {
                                                                                                                                            echo date('m/d/Y', strtotime($settlement_date));
                                                                                                                                        } ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onblur="get_investment_amount();" id="units" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 ' name="units" value="<?php if (isset($units)) {
                                                                                                                                                                                                                                                echo $units;
                                                                                                                                                                                                                                            } ?>" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onblur="get_investment_amount();" id="shares" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 ' value="<?php if (isset($shares)) {
                                                                                                                                                                                                                                    echo $shares;
                                                                                                                                                                                                                                } ?>" name="shares" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="9" onChange="setnumber_format(this)" class="form-control" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 ' name="charge_amount" value="<?php if (isset($charge_amount) && $charge_amount != '') {
                                                                                                                                                                                                                                                        echo $charge_amount;
                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                        echo '0';
                                                                                                                                                                                                                                                    } ?>" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" data-required="true" onclick="open_split_modal()" name="split" id="split_yes" <?php if (isset($split) && $split == 1) {
                                                                                                                                                                    echo 'checked="true"';
                                                                                                                                                                } ?> value="1" />YES
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" data-required="true" onclick="close_other()" name="split" id="split_no" <?php if ((isset($split) && $split == 2) || (isset($_GET['action']) && $_GET['action'] == 'add')) {
                                                                                                                                                                echo 'checked="true"';
                                                                                                                                                            } ?> value="2" />NO
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" data-required="true" id="hold_commission_1" name="hold_commission" onclick="open_hold_reason();" value="1" <?php if (isset($hold_commission) and $hold_commission == '1') {
                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                } ?> />
                                                YES</label>
                                            <label class="radio-inline">
                                                <!-- <?php //if((isset($hold_commission) && $hold_commission!='1') || (isset($_GET['action']) && $_GET['action']=='add')){ $TestDeleteMe="echo 'checked='true'"; }
                                                        ?> -->
                                                <input type="radio" class="radio" data-required="true" id="hold_commission_2" name="hold_commission" onclick="hide_hold_reason();" value="2" <?php if (!(isset($hold_commission) and $hold_commission == '1')) {
                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                } ?> />
                                                NO</label>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="buy_sell" <?php if ((isset($buy_sell) && $buy_sell == 1) || (isset($_GET['action']) && $_GET['action'] == 'add')) {
                                                                                                        echo 'checked="true"';
                                                                                                    } ?> value="1" />Buy
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="buy_sell" <?php if (isset($buy_sell) && $buy_sell == 2) {
                                                                                                        echo 'checked="true"';
                                                                                                    } ?> value="2" />Sell
                                            </label>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="cancel" <?php if (isset($cancel) && $cancel == 1) {
                                                                                                    echo 'checked="true"';
                                                                                                } ?> value="1" />YES
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="cancel" <?php if ((isset($cancel) && $cancel == 2) || (isset($_GET['action']) && $_GET['action'] == 'add')) {
                                                                                                    echo 'checked="true"';
                                                                                                } ?> value="2" />NO
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="is_1035_exchange" <?php if (isset($is_1035_exchange) && $is_1035_exchange == 1) {
                                                                                                                echo 'checked="true"';
                                                                                                            } ?> value="1" />YES

                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="is_1035_exchange" <?php if ((isset($is_1035_exchange) && $is_1035_exchange == 0) || (isset($_GET['action']) && $_GET['action'] == 'add')) {
                                                                                                                echo 'checked="true"';
                                                                                                            } ?> value="0" />NO
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="is_trail_trade" <?php if (isset($is_trail_trade) && $is_trail_trade == 1) {
                                                                                                            echo 'checked="true"';
                                                                                                        } ?> value="1" />YES

                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="is_trail_trade" <?php if ((isset($is_trail_trade) && $is_trail_trade == 0) || (isset($_GET['action']) && $_GET['action'] == 'add')) {
                                                                                                            echo 'checked="true"';
                                                                                                        } ?> value="0" />NO
                                            </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="posting_date" style="visibility: hidden;">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="posting_date" id="posting_date" disabled="true" value="<?php if (isset($posting_date) && $posting_date != '0000-00-00') {
                                                                                                                                    echo date('m/d/Y', strtotime($posting_date));
                                                                                                                                } else if (isset($_GET['action']) && $_GET['action'] == 'add') {
                                                                                                                                    echo date('m/d/Y');
                                                                                                                                } else {
                                                                                                                                    echo '';
                                                                                                                                } ?>" class="form-control" />
                                                <input type="hidden" name="posting_date" id="posting_date" value="<?php if (isset($posting_date) && $posting_date != '0000-00-00') {
                                                                                                                        echo date('m/d/Y', strtotime($posting_date));
                                                                                                                    } else if (isset($_GET['action']) && $_GET['action'] == 'add') {
                                                                                                                        echo date('m/d/Y');
                                                                                                                    } else {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6" id="div_hold_reason" style="<?php if (isset($hold_commission) && $hold_commission == 1) {
                                                                                        echo 'display:true';
                                                                                    } else {
                                                                                        echo 'display:none';
                                                                                    } ?>">
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="text"  class="form-control" value="<?php //if(isset($hold_reason)) {echo $hold_reason;}
                                                                                                ?>" name="hold_reason" id="hold_reason"  /> -->
                                        <textarea type="text" class="form-control" name="hold_reason" id="hold_reason" rows="5" wrap="off" />
                                        <?php if (isset($hold_reason)) {
                                            echo $hold_reason;
                                        } ?>
                                        </textarea>
                                    </div>
        ...
        <div class="inputpopup">
            ...
            <input type="text" name="ch_amount" onChange="setnumber_format(this)"  value="<?php if (isset($ch_amount)) {
                                                                                                echo $ch_amount;
                                                                                            } ?>" id="ch_amount" class="form-control" />
        </div>
        <div class="inputpopup">
        ...
        <div class="inputpopup">
            ...
            <input type="text" name="ch_pay_to" maxlength="40"  value="<?php if (isset($ch_pay_to)) {
                                                                            echo $ch_pay_to;
                                                                        } ?>" id="ch_pay_to" class="form-control" />
        </div>
        <div class="col-md-12">
            <div id="msg">
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6" style="float: right;">
                             <form method="post">
                                ...
                                <input type="text"  name="search_text" id="search_text_batches" value="<?php if (isset($search_text_batches)) {
                                                                                                            echo $search_text_batches;
                                                                                                        } ?>"/>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#branch").change(function(e) {
            get_branch_company($(this).val());
        });
        $("#product_cate").change(function(e) {
            get_product($(this).val());
        });
        $("#sponsor").change(function(e) {
            get_product();
        });
