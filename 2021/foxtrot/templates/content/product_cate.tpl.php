                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="window.location.href='<?php echo $editLink; ?>'" style="cursor:pointer"><?php echo $val['cusip']; ?></td>
                                        <td onclick="window.location.href='<?php echo $editLink; ?>'" style="cursor:pointer"><?php echo $val['sponsor']; ?></td>
                                        <td class="text-center">
                                            <?php
                                            if ($val['status'] == 1) {
                                            ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="window.location.href='<?php echo $editLink; ?>'" style="cursor:pointer"><?php echo $val['name']; ?></td>
                                        <td onclick="window.location.href='<?php echo $editLink; ?>'" style="cursor:pointer"><?php echo $val['type']; ?></td>
                                        <td onclick="window.location.href='<?php echo $editLink; ?>'" style="cursor:pointer"><?php echo $val['cusip']; ?></td>
                                        <td onclick="window.location.href='<?php echo $editLink; ?>'" style="cursor:pointer"><?php echo $val['sponsor']; ?></td>
                                        <td class="text-center">
                                            <?php
