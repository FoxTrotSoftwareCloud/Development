                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="report_for" id="report_for">
                            ...
                            <option value="7" <?php if (isset($report_for) && $report_for == 7) {
                                                    echo "selected='true'";
                                                } ?>>Compliance Exceptions Report</option>
                            <option value="3" <?php if (isset($report_for) && $report_for == 3) {
                                                    echo "selected='true'";
                                                } ?>>Client Review Report</option>
                            <option value="9" <?php if (isset($report_for) && $report_for == 9) {
                                                    echo "selected='true'";
                                                } ?>>Broker Sponsor Appointments Listing</option>
                            <option value="10" <?php if (isset($report_for) && $report_for == 10) {
                                                    echo "selected='true'";
                                                } ?>>CIP Report</option>
                            <option value="5" <?php if (isset($report_for) && $report_for == 5) {
                                                    echo "selected='true'";
                                                } ?>>Broker State Licenses Report</option>
                            <option value="2" <?php if (isset($report_for) && $report_for == 2) {
                                                    echo "selected='true'";
                                                } ?>>Broker License Renewal Statements</option>
                            <option value="1" <?php if (isset($report_for) && $report_for == 1) {
                                                    echo "selected='true'";
                                                } ?>>E&O Statements</option>
                            <option value="1" <?php if (isset($report_for) && $report_for == 4) {
                                                    echo "selected='true'";
                                                } ?>>Broker Registrations Report</option>
                            <option value="1" <?php if (isset($report_for) && $report_for == 4) {
                                                    echo "selected='true'";
                                                } ?>>Branch Audit Report</option>
                            <option value="1" <?php if (isset($report_for) && $report_for == 4) {
                                                    echo "selected='true'";
                                                } ?>>Client Activity/Churning Report</option>

                            <option value="1" <?php if (isset($report_for) && $report_for == 4) {
                                                    echo "selected='true'";
                                                } ?>>Continuing Education Report</option>
                            <!--      <option value="1" <?php if (isset($report_for) && $report_for == 4) {
                                                            echo "selected='true'";
                                                        } ?>>OFAC Activity Report</option>
                        <option value="1" <?php if (isset($report_for) && $report_for == 4) {
                                                echo "selected='true'";
                                            } ?>>FINCEN Activity Report</option> -->
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" class="radio" name="cip_client" id="all_clients" value="2" <?php if (isset($cip_client) && ($cip_client == '2' || $cip_client == '')) {
                                                                                                                            echo "checked='checked'";
                                                                                                                        } ?> />&nbsp; All Clients &nbsp;
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" class="radio" name="cip_client" id="cip_clients" style="display: inline;" value="1" <?php if (isset($cip_client) && $cip_client == '1') {
                                                                                                                                                    echo "checked='checked'";
                                                                                                                                                } ?> />&nbsp; Clients With CIP Data &nbsp;
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row appointments">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" class="radio" name="allias_groupby" id="broker" value="broker" <?php if (isset($allias_groupby) && ($allias_groupby == 'broker' || $allias_groupby == '')) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> />&nbsp; Group by Broker &nbsp;
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" class="radio" name="allias_groupby" id="sponsor" style="display: inline;" value="sponsor" <?php if (isset($allias_groupby) && $allias_groupby == 'sponsor') {
                                                                                                                                                            echo "checked='checked'";
                                                                                                                                                        } ?> />&nbsp;Group by Sponsor &nbsp;
                                    </label>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (<?php echo $report_for ?> == 9) {
                ...
                xmlhttp.open('GET', 'ajax_client_cip_report.php?filter=<?php echo $_GET['filter']; ?>', true);
            } else if (<?php echo $report_for ?> != 10) {
