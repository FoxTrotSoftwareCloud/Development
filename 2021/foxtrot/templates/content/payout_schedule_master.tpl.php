                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="schedule_name" id="schedule_name" class="form-control" value="<?php if (isset($schedule_name) && $schedule_name != '') {
                                                                                                                                    echo $schedule_name;
                                                                                                                                } ?>" />
                                    </div>
                                </div>
                        ...
                        <div class="panel" style="border: 1px solid #cccccc !important; padding: 10px !important;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="basis" <?php if (isset($basis) && $basis == '1') { ?>checked="true" <?php } else if (!isset($basis) || $basis == 0) { ?>checked="true" <?php } ?> class="radio" style="display: inline;" value="1" />&nbsp;<label>Gross Concessions</label>&nbsp;&nbsp;
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="cumulative" <?php if (isset($cumulative) && $cumulative == '1') { ?>checked="true" <?php } else if (!isset($cumulative) || $cumulative == 0) { ?>checked="true" <?php } ?> class="radio" style="display: inline;" value="1" />&nbsp;<label>Payroll-To-Date</label>&nbsp;&nbsp;
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Year </label><br />
                                        <input type="radio" name="year" <?php if (isset($year) && $year == '1') { ?>checked="true" <?php } else if (!isset($year) || $year == 0) { ?>checked="true" <?php } ?> class="radio" style="display: inline;" value="1" />&nbsp;<label>Calendar</label>&nbsp;&nbsp;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="reset" value="<?php if (isset($reset) && $reset != '') {
                                                                                            echo date('m/d/Y', strtotime($reset));
                                                                                        } ?>" class="form-control" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="calculation_detail" <?php if (isset($calculation_detail) && $calculation_detail == '1') { ?>checked="true" <?php } else if (!isset($calculation_detail) || $calculation_detail == 0) { ?>checked="true" <?php } ?> class="radio" style="display: inline;" value="1" />&nbsp;<label>Apply Incremental Payout Rate</label>&nbsp;&nbsp;
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description_type" value="<?php if (isset($description_type) && $description_type != '') {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="minimum_trade_gross" value="<?php if (isset($minimum_trade_gross) && $minimum_trade_gross != '') {
                                                                                                echo $minimum_trade_gross;
                                                                                            } ?>" class="form-control" />
                                    <span class="input-group-addon">$</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="minimum_12B1_gross" value="<?php if (isset($minimum_12B1_gross) && $minimum_12B1_gross != '') {
                                                                                                echo $minimum_12B1_gross;
                                                                                            } ?>" class="form-control" />
                                    <span class="input-group-addon">$</span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="checkbox" name="is_default" id="is_default" value="1" <?php if (isset($is_default) && $is_default > 0) {
                                                                                                                            echo 'checked';
                                                                                                                        } ?> />
                                </div>
                            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $editLink ?>'" style="cursor:pointer"><?php echo $val['payout_schedule_name']; ?></td>
                                    <td class="text-center">
                                        <?php
                                        if ($val['status'] == 1) {
                                        ?>
