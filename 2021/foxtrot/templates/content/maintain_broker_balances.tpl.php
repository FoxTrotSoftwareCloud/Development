                        ...
                        <table id="data-table" class="table table-striped1 table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($return as $key => $val) {
                                    $brokerEditLink = CURRENT_PAGE . "?action=edit&id=" . $val['id'];
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $brokerEditLink ?>'" style="cursor:pointer"><?php echo $val['broker_firstname'] . ' ' . $val['broker_lastname']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $brokerEditLink ?>'" style="cursor:pointer"><?php echo $val['broker_number']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $brokerEditLink ?>'" style="cursor:pointer"><?php echo $val['clearing_number']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $brokerEditLink ?>'" style="cursor:pointer"><?php echo $val['balance_amount']; ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
