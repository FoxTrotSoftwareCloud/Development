                                            ...
                                            <td>
                                                <?php if ($masterRow['id'] == 3) { ?>
                                                    <div id="other_div<?php echo $masterKey; ?>" class="form-group">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control decimal" onchange="handleChange(this);" value="<?php if (isset($detailRow['parameter_1']) && $detailRow['parameter_1'] != '') {
                                                                                                                                                        echo $detailRow['parameter_1'];
                                                                                                                                                    } ?>" name="data[<?php echo $masterKey; ?>][parameter_1]" maxlength="13" />
                                                ...
                                                <?php } else if ($masterRow['id'] == 16) { ?>
                                                    <div id="other_div<?php echo $masterKey; ?>" class="form-group" <?php if (isset($detailRow['action']) && $detailRow['action'] == '5') { ?>style="display: none;" <?php } ?>>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" value="<?php if (isset($detailRow['parameter_1']) && $detailRow['parameter_1'] != '') {
                                                                                                                echo $detailRow['parameter_1'];
                                                                                                            } ?>" name="data[<?php echo $masterKey; ?>][parameter_1]" maxlength="4" />
                                                            <span class="input-group-addon">$</span>
                                                        </div>
                                                    </div>
                                                <?php } else { ?>
                                                    <div id="other_div<?php echo $masterKey; ?>" class="form-group" <?php if (isset($detailRow['action']) && $detailRow['action'] == '5') { ?>style="display: none;" <?php } ?>>
                                                        <input type="text" class="form-control" value="<?php if (isset($detailRow['parameter_1']) && $detailRow['parameter_1'] != '') {
                                                                                                            echo $detailRow['parameter_1'];
                                                                                                        } ?>" name="data[<?php echo $masterKey; ?>][parameter_1]" maxlength="13" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode==46 || event.charCode==45' />
                                                    </div>
                                                <?php } ?>
                                            ...
                                            <td>
                                                ...
                                                <?php } else if ($masterRow['id'] != 16) { ?>
                                                    <div id="other_div_2<?php echo $masterKey; ?>" class="form-group" <?php if (isset($detailRow['action']) && $detailRow['action'] == '5') { ?>style="display: none;" <?php } ?>>
                                                        <input type="text" class="form-control" value="<?php if (isset($detailRow['parameter_2']) && $detailRow['parameter_2'] != '') {
                                                                                                            echo $detailRow['parameter_2'];
                                                                                                        } ?>" name="data[<?php echo $masterKey; ?>][parameter_2]" maxlength="13" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode==46 || event.charCode==45' />
                                                    </div>
                                                <?php } ?>
                                            </td>
                                        </tr>
