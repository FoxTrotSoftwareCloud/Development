                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="40" class="form-control" name="batch_desc" id="batch_desc" value="<?php if (isset($batch_desc)) {
                                                                                                                                        echo $batch_desc;
                                                                                                                                    } ?>" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="10" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="batch_number" disabled="true" value="<?php if (isset($batch_number) && $batch_number != '') {
                                                                                                                                                                                                            echo $batch_number;
                                                                                                                                                                                                        } else {
                                                                                                                                                                                                            echo 'Will be Assigned When Saving';
                                                                                                                                                                                                        } ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="12" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 ' name="commission_amount1" value="<?php if (isset($commission_amount) && $commission_amount != '') {
                                                                                                                                                                                                                                echo number_format($commission_amount, 2);
                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                echo '0';
                                                                                                                                                                                                                            } ?>" <?php if (isset($_GET['action']) && ($action == 'edit_batches' || $action == 'add_batches')) {
                                                                                                                                                                                                                                        echo "disabled='true'";
                                                                                                                                                                                                                                    } ?> />
                                        <input type="hidden" class="form-control" maxlength="12" onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 ' name="commission_amount" value="<?php if (isset($commission_amount) && $commission_amount != '') {
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon">$</span>
                                        <input type="text" class="form-control" maxlength="12" name="check_amount" id="check_amount" value="<?php if (isset($check_amount) && $check_amount != '') {
                                                                                                                                                echo number_format($check_amount, 2);
                                                                                                                                            } else {
                                                                                                                                                echo '0';
                                                                                                                                            } ?>" />
                                    </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="demo-dp-range">
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" name="batch_date" id="batch_date" value="<?php if (isset($batch_date) && ($batch_date != '' && $batch_date != '0000-00-00')) {
                                                                                                            echo date('m/d/Y', strtotime($batch_date));
                                                                                                        } ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="demo-dp-range">
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" name="deposit_date" id="deposit_date" value="<?php if (isset($deposit_date) && ($deposit_date != '' && $deposit_date != '0000-00-00')) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="demo-dp-range">
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" name="trade_start_date" id="trade_start_date" value="<?php if (isset($trade_start_date) && ($trade_start_date != '' && $trade_start_date != '0000-00-00')) {
                                                                                                                        echo date('m/d/Y', strtotime($trade_start_date));
                                                                                                                    } ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div id="demo-dp-range">
                                        <div class="input-daterange input-group" id="datepicker">
                                            <input type="text" name="trade_end_date" id="trade_end_date" value="<?php if (isset($trade_end_date) && ($trade_end_date != '' && $trade_end_date != '0000-00-00')) {
                                                                                                                    echo date('m/d/Y', strtotime($trade_end_date));
                                                                                                                } ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                          <input type="radio" class="radio" onclick="open_other()" name="split" <?php if (isset($split) && $split == 1) {
                                                                                                    echo 'checked="true"';
                                                                                                } ?>   value="1"/>YES
                        </label>
                        <label class="radio-inline">
                          <input type="radio" class="radio" onclick="close_other()" name="split" <?php if (isset($split) && $split == 2) {
                                                                                                        echo 'checked="true"';
                                                                                                    } ?> value="2" />NO
                        </label>
                    </div>
                ...
                <div class="row">
                    <div id="other_div" class="form-group" <?php if ((isset($split) && $split != 1) || !isset($split)) { ?>style="display: none;<?php } ?>">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class=" form-control" type="text" name="prompt_for_check_amount" placeholder="Enter prompt for Check Amount" value="<?php if (isset($prompt_for_check_amount) && (isset($split) && $split == 1)) {
                                                                                                                                                                echo $prompt_for_check_amount;
                                                                                                                                                            } else {
                                                                                                                                                                echo '';
                                                                                                                                                            } ?>"/>
                            </div>
                            <div class="col-md-6">
                                <input class="form-control" type="text" name="posted_amounts"  placeholder="Enter Posted amounts"  value="<?php if (isset($posted_amounts) && (isset($split) && $split == 1)) {
                                                                                                                                                echo $posted_amounts;
                                                                                                                                            } else {
                                                                                                                                                echo '';
                                                                                                                                            } ?>"/>
        ...
        if ((isset($_GET['action']) && $_GET['action'] == 'view_batches') || $action == 'view_batches') { ?>
            ...
            <div class="col-md-6" style="float: right;">
             <form method="post">
                ...
                <input type="text"  name="search_text_batches" id="search_text_batches" value="<?php if (isset($search_text_batches)) {
                                        ...
                                        <td onclick="window.location.href='<?php echo $editLink ?>'" title="Click to edit" class="td_space" style="width: 20%; cursor:pointer; vertical-align: middle;"><?php
                                                                                                                                                                                                        if ($val['sponsor'] == -1) {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            foreach ($get_sponsor as $ke => $va) {
                                                                                                                                                                                                                if (isset($val['sponsor']) && $val['sponsor'] == $va['id']) {
                                                                                                                                                                                                                    echo $va['name'];
                                                                                                                                                                                                                }
                                                                                                                                                                                                            }
                                                                                                                                                                                                        }
