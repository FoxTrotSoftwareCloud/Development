                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>OSJ </label><br />
                                        <input type="checkbox" name="osj" id="osj" class="checkbox" value="1" <?php if ($osj > 0) {
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="non_registered" id="non_registered" class="checkbox" value="1" <?php if ($non_registered > 0) {
                                                                                                                                        echo "checked='checked'";
                                                                                                                                    } ?> />
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="broker">
                                            ...
                                            <?php foreach ($get_broker as $key => $val) { ?>
                                                <option value="<?php echo $val['id']; ?>" <?php if ($broker != '' && $broker == $val['id']) {
                                                                                                echo "selected='selected'";
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="b_status">
                                            ...
                                            <option value="1" <?php if ($b_status == 1) {
                                                                    echo "selected='selected'";
                                                                } ?>>FINRA - OSJ</option>
                                            <option value="2" <?php if ($b_status == 2) {
                                                                    echo "selected='selected'";
                                                                } ?>>FINRA - Branch</option>
                                            <option value="3" <?php if ($b_status == 3) {
                                                                    echo "selected='selected'";
                                                                } ?>>Individual/Sole Proprietorship</option>
                                            <option value="4" <?php if ($b_status == 4) {
                                                                    echo "selected='selected'";
                                                                } ?>>Unregistered</option>
                                            <option value="5" <?php if ($b_status == 5) {
                                                                    echo "selected='selected'";
                                                                } ?>>Financial Institution - Local</option>
                                            <option value="6" <?php if ($b_status == 6) {
                                                                    echo "selected='selected'";
                                                                } ?>>Financial Institution - HQ</option>
                                            <option value="7" <?php if ($b_status == 7) {
                                                                    echo "selected='selected'";
                                                                } ?>>State Branch</option>
                                        </select>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="business_state" id="business_state" class="form-control">
                                                ...
                                                <?php foreach ($get_state as $key => $val) { ?>
                                                    <option value="<?php echo $val['id']; ?>" <?php if ($business_state != '' && $business_state == $val['id']) {
                                                                                                    echo "selected='selected'";
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="mailing_state" id="mailing_state" class="form-control">
                                                <option value="">Select State</option>
                                                <?php foreach ($get_state as $key => $val) { ?>
                                                    <option value="<?php echo $val['id']; ?>" <?php if ($mailing_state != '' && $mailing_state == $val['id']) {
                                                                                                    echo "selected='selected'";
                                                                                                } ?>><?php echo $val['name']; ?></option>
                                                <?php } ?>
                                            </select>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="date_established" id="date_established" class="form-control" value="<?php if ($date_established != '' && $date_established != "1970-01-01") {
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="date_terminated" id="date_terminated" class="form-control" value="<?php if ($date_terminated != '' && $date_terminated != "1970-01-01") {
                                                                                                                                                echo date('m/d/Y', strtotime($date_terminated));
                                                                                                                                            } ?>" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="finra_start_date" id="finra_start_date" class="form-control" value="<?php if ($finra_start_date != '' && $finra_start_date != "1970-01-01") {
                                                                                                                                                    echo date('m/d/Y', strtotime($finra_start_date));
                                                                                                                                                } ?>" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="finra_end_date" id="finra_end_date" class="form-control" value="<?php if ($finra_end_date != '' && $finra_end_date != "1970-01-01") {
                                                                                                                                                echo date('m/d/Y', strtotime($finra_end_date));
                                                                                                                                            } ?>" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="last_audit_date" id="last_audit_date" class="form-control" value="<?php if ($last_audit_date != '' && $last_audit_date != "1970-01-01") {
                                                                                                                                                echo date('m/d/Y', strtotime($last_audit_date));
                                                                                                                                            } ?>" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="table-responsive" id="table-scroll" style="margin: 0px 5px 0px 5px;">
                            <table class="table table-bordered table-stripped table-hover">
                                ...
                                <tbody>
                                    ...
                                    $lable_array = array();
                                    $lable_array = array(
                                        'name' => 'Branch Name', 'broker' => 'Manager', 'b_status' => 'Status', 'contact' => 'Contact', 'osj' => 'OSJ',
...
', 'date_terminated' => 'Date Terminated', 'finra_start_date' => 'FINRA Start Date', 'finra_end_date' => 'FINRA End Date', 'last_audit_date' => 'Last Audit Date'
                                    ...
                                    foreach ($branch_data as $key => $val) {
                                        ...
                                        <tr>
                                            ...
                                            <?php } else if ($feild_name == 'OSJ' && $val['old_value'] == 1) { ?>
                                                <td><?php echo 'Checked'; ?></td>
                                                <td><?php echo 'UnChecked'; ?></td>
                                            <?php } else if ($feild_name == 'Non-Registered' && $val['old_value'] == 0) { ?>
                                                <td><?php echo 'UnChecked'; ?></td>
                                                <td><?php echo 'Checked'; ?></td>
                                            <?php } else if ($feild_name == 'Non-Registered' && $val['old_value'] == 1) { ?>
                                                <td><?php echo 'Checked'; ?></td>
                                                <td><?php echo 'UnChecked'; ?></td>
                                            <?php } else if ($feild_name == 'Manager') {
