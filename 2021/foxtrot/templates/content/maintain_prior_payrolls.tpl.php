                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="demo-dp-range">
                                            <div class="input-daterange input-group" id="datepicker">
                                                <input type="text" name="payroll_date" id="payroll_date" class="form-control required" value="<?php if ($payroll_date != '') {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="col-md-6 form-control required" name="rep_name" id="rep_name">
                                            ...
                                            <?php foreach ($get_broker as $key => $val) { ?>
                                                <option value="<?php echo $val['id']; ?>" <?php if ($rep_name != '' && $rep_name == $val['id']) {
                        ...
                        <th>Net Earnings</th>-->
                            ...
                            <tbody>
                                ...
                                foreach ($return as $key => $val) {
                                    $ytdEditLink = CURRENT_PAGE . "?action=edit&id=" . $val['id'];
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo date('m/d/Y', strtotime($val['payroll_date'])); ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['broker_firstname'] . ' ' . $val['broker_lastname']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['rep_number']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['clearing_number']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['gross_production']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['check_amount']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['taxable_adjustments']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $ytdEditLink ?>'" style="cursor:pointer"><?php echo $val['non-taxable_adjustments']; ?></td>
