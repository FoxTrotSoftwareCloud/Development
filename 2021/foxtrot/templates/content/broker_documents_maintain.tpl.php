                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="30" class="form-control" name="desc" value="<?php if (isset($desc)) {
                                                                                                                    echo $desc;
                                                                                                                } ?>" />
                                </div>
                            </div><br />
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $editLink ?>'" style="cursor:pointer"><?php echo $val['desc']; ?></td>
                                        <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $editLink ?>'" style="cursor:pointer"><?php if ($val['required'] == '1') {
                                                                                                                                                        echo 'Required';
                                                                                                                                                    } else {
                                                                                                                                                        echo 'Not required';
                                                                                                                                                    } ?></td>
