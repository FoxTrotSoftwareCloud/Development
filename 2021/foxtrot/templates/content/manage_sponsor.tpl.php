                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sstate">
                                        ...
                                        <?php foreach ($get_state as $key => $val) { ?>
                                            <option value="<?php echo $val['id']; ?>" <?php if ($sstate == $val['id']) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Exclude from DST Importing <input type="checkbox" class="checkbox" name="sdst_import" id="cpa" value="1" style="display: inline;" <?php if ($sdst_import > 0) {
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Exclude from DAZL Importing <input type="checkbox" class="checkbox" name="sdazl_import" id="" value="1" style="display: inline;" <?php if ($sdazl_import > 0) {
                                                                                                                                                                                echo "checked='checked'";
                                                                                                                                                                            } ?> />
                                    </label>
                                </div>
...
', 'city' => 'City', 'state' => 'State', 'zip_code' => 'Zip Code', 'email' => 'E-Mail', 'website' => 'Web Site', 'general_contact' => 'General Contact', 'general_phone' => 'General Phone', 'operations_contact' => 'Operations Contact', 'operations_phone' => 'Operations Phone', 'dst_system_id' => 'DST System ID', 'dst_mgmt_code' => 'DST Mgmt Code', 'dst_importing' => 'Exclude from DST Importing', 'dazl_importing' => 'Exclude from DAZL Importing', 'dazl_code' => 'DAZL Code', 'dtcc_nscc_id' => 'DTCC/NSCC ID', 'clearing_firm_id' => 'Clearing Firm ID');
                                            foreach ($sponsor_data as $key => $val) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } else if ($feild_name == 'Exclude from DST Importing' && $val['old_value'] == 1) { ?>
                                                        <td><?php echo 'Checked'; ?></td>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                    <?php } else if ($feild_name == 'Exclude from DAZL Importing' && $val['old_value'] == 0) { ?>
                                                        <td><?php echo 'UnChecked'; ?></td>
                                                        <td><?php echo 'Checked'; ?></td>
                                                    <?php } else if ($feild_name == 'Exclude from DAZL Importing' && $val['old_value'] == 1) { ?>
                                                        <td><?php echo 'Checked'; ?></td>
                                                        <td><?php echo 'UnChecked'; ?></td>
