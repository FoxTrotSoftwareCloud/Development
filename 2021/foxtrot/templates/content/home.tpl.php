...
<script type="text/javascript" lang="javaScript">
    $(document).ready(function() {
        ...
        var data_investment_amount = <?php if ($invest_amount == '') {
                                            echo '0';
                                        } else {
                                            echo $invest_amount;
                                        } ?>;
        var data_charge_amount = <?php if ($charge_amount == '') {
                                        echo '0';
                                    } else {
                                        echo $charge_amount;
                                    } ?>;
        var data_commission_received_amount = <?php if ($commission_received_amount == '') {
                                                    echo '0';
                                                } else {
                                                    echo $commission_received_amount;
                                                } ?>;
                        ...
                        <table width='100%' class="graphdata02 <?php print $dailyImportingStatus; ?>">
                            <tr>
                                ...
                                <td rowspan="5" width='60%'>
                                    <div id="container_daily_importing" style="min-width: 200px; height: 200px;  max-width: 3000px; margin:  auto"></div>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table width='100%' class="graphdata02_2 <?php print $commissionsStatus; ?>">
                            <tr class="text-right">
                                ...
                                <td rowspan="5" style="width: 60%;">
                                    <div id="container_commission" style="min-width: 200px; height: 200px; max-width: 3000px; margin:  auto"></div>
                                </td>
                            </tr>
                            <tr class="text-right">
                ...
                <div class="graphbox graphbox02">
                    ...
                    <div class="graphboxcontent dailyimporting">
                        ...
                        <table width='100%' class="graphdata02_4 <?php print $complianceStatus; ?>">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div id="container3" style="min-width: 290px; height: 290px; margin: 0 auto"></div>
                                </td>
                            </tr>
                        </table>
                        <div class="graphimg">
                        ...
                        <table width='100%' class="graphdata02_5 <?php print $ytdProductionStatus; ?>">
                            <tr>
                                <td colspan="4" width='60%'>
                                    <div id="container2" style="min-width: 190px; max-width: 800px; height: 350px; margin: 0 auto"></div>
                                </td>
                            </tr>
                            <?php
                            foreach ($ytd_product_category as $key => $val) {
