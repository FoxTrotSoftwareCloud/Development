                        ...
                        <div class="fox-reporting-options">
                            ...
                            <div class="row year_to_date_filter_wrap" id="year_to_date_filter_wrap">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="earning_by" id="earning_by_broker" value="1" <?php if ($sort_by == 1 || $sort_by == '') {
                                                                                                                                        echo 'checked="checked"';
                                                                                                                                    } ?> />&nbsp; Earnings By Broker
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="earning_by" id="earning_by_branch" value="2" <?php if (isset($sort_by) && ($sort_by == 2)) {
                                                                                                                                        echo 'checked="checked"';
                                                                                                                                    } ?> />&nbsp; Earnings By Branch
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="checkbox" class="checkbox" name="without_earning" id="without_earning" style="display: inline;" value="1" <?php if (isset($without_earning) && ($without_earning == 1)) {
                                                                                                                                                                    echo "checked='checked'";
                                                                                                                                                                } ?> /> Include Brokers With No Earnings
                                    </div>
                                </div>
                                <!--  <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" class="radio" name="year_output" id="output_to_screen" style="display: inline;" value="1" <?php if (isset($output) && ($output == 1 || $output == '')) {
                                                                                                                                                    echo "checked='checked'";
                                                                                                                                                } ?>/> Output to Screen&nbsp;&nbsp;&nbsp;
                                <input type="radio" class="radio" name="year_output" id="output_to_printer" style="display: inline;" value="2" <?php if (isset($output) && $output == 2) {
                                                                                                                                                    echo "checked='checked'";
                                                                                                                                                } ?>/> Output to Printer&nbsp;&nbsp;&nbsp; 
                             <input type="radio"  class="radio" name="year_output" id="output_to_excel" style="display: inline;" value="3" <?php if (isset($output) && $output == 3) {
                                                                                                                                                echo "checked='checked'";
                                                                                                                                            } ?>/> Output to Excel&nbsp;&nbsp;&nbsp; 
                                <input type="radio" class="radio" name="year_output" id="output_to_pdf" style="display: inline;" value="4" <?php if (isset($output) && $output == 4) {
                                                                                                                                                echo "checked='checked'";
                                                                                                                                            } ?>/> Output to PDF
                            </div>
                        </div> -->
                            ...
                            <div class="row broker_ranking_filter_wrap" id="broker_ranking_filter_wrap">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group" style="margin-top:1.5em ;">
                                        ...
                                        <?php
                                        $ranks = [
                                            'Rank on Total Earnings', 'Rank on Gross Concessions', 'Rank on Total Sales',
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input type="radio" class="radio earning_by" name="date_earning_by" id="earning_by" value="1" <?php if (isset($sort_by) && ($sort_by == 1 || $sort_by == '')) {
                                                                                                                                                echo "checked='checked'";
                                                                                                                                            } ?> />&nbsp; Current Payroll
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio earning_by" name="date_earning_by" id="earning_by" value="2" <?php if (isset($sort_by) && ($sort_by == 2)) {
                                                                                                                                                echo "checked='checked'";
                                                                                                                                            } ?> /> &nbsp; Specified Date Range
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-12 date-options" <?php if (isset($sort_by) && ($sort_by == 1 || $sort_by == '')) {
                        ...
                        */ ?>
                            ...
                            <div class="row sort_by_options" id="div_sort_by">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="sort_by" id="sort_by" value="1" <?php if (isset($sort_by) && ($sort_by == 1 || $sort_by == '')) {
                                                                                                                        echo "checked='checked'";
                                                                                                                    } ?> />&nbsp; Sort by Sponsor&nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="sort_by" id="sort_by" style="display: inline;" value="2" <?php if (isset($sort_by) && ($sort_by == 2)) {
                                                                                                                                                    echo "checked='checked'";
                            ...
                            <div class="row transaction-date-options" id="div_date_by">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="date_by" id="date_by" value="1" <?php if (isset($date_by) && ($date_by == 1 || $date_by == '')) {
                                                                                                                        echo "checked='checked'";
                                                                                                                    } ?> />&nbsp; Transaction Date&nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="date_by" id="date_by" value="2" <?php if (isset($date_by) && ($date_by == 2)) {
                                                                                                                        echo "checked='checked'";
                            ...
                            <div class="row output-options">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="output" id="output_to_screen" value="1" <?php if (isset($output) && ($output == 1 || $output == '')) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> />&nbsp; Output to Screen&nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="output" id="output_to_printer" value="2" <?php if (isset($output) && $output == 2) {
                                                                                                                                    echo "checked='checked'";
                                                                                                                                } ?> />&nbsp; Output to Printer&nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="output" id="output_to_excel" value="3" <?php if (isset($output) && $output == 3) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> />&nbsp; Output to Excel&nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" class="radio" name="output" id="output_to_pdf" value="4" <?php if (isset($output) && $output == 4) {
                                                                                                                                echo "checked='checked'";
                                                                                                                            } ?> />&nbsp; Output to PDF
                                        </label>
                                    </div>
        ...
        $("#report_form").submit(function(ev) {
            ...
            if (output_type == 4 || output_type == 2) {
                ...
                if ($("#report_for").val() == "broker") {
                    url = "http://localhost/CloudFox/Development/2021/foxtrot/sales_broker_report_print.php?filter=" + JSON.stringify(formData_obj);
                } else {
                    url = "http://localhost/CloudFox/Development/2021/foxtrot/sales_report_print.php?filter=" + JSON.stringify(formData_obj);
                }
...
<style>
    ...
    thead.modal-heading-row tr,
    tr.t-footer-items {
        background-color: #f1f1f1;
    }

    /*tr.t-footer-items td.total {font-size: 14px;}*/
    tr.t-footer-items td {
        font-weight: bold;
        font-size: 12px;
    }
