...
<div class="container">
    <h1 class="<?php if ($action == 'add_new' || ($action == 'edit' && $id > 0)) {
                    'topfixedtitle';
                } ?>">Multi-Company Maintenance</h1>
    <div class="col-lg-12 well <?php if ($action == 'add_new' || ($action == 'edit' && $id > 0)) {
                                    'fixedwell';
                                } ?>">
            ...
            <div class="tab-pane active" id="tab_a">
                ...
                ?>
                    <form method="post" onsubmit="return check_Threshold()">
                        <ul class="nav nav-tabs <?php if ($action == 'add_new' || ($action == 'edit' && $id > 0)) {
                                                    'topfixedtabs';
                                                } ?>">
                        ...
                        <div class="tab-content panel">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_name" id="company_name" value="<?php if ($action == 'edit') {
                                                                                                                echo $company_name;
                                                                                                            } ?>" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_type" id="company_type" value="<?php if ($action == 'edit') {
                                                                                                                echo $company_type;
                                                                                                            } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <!--input type="text" name="manager_name" id="manager_name" value="<?php if ($action == 'edit') {
                                                                                                                    echo $manager_name;
                                                                                                                } ?>"  class="form-control" /-->
                                            <select name="manager_name" id="manager_name" class="form-control">
                                                <option value="0">Select Manager</option>
                                                <?php foreach ($get_manager as $statekey => $stateval) { ?>
                                                    <option <?php if ($action == 'edit') {
                                                                if ($manager_name == $stateval['id']) { ?>selected="true" <?php }
                                                                                                                    } ?> value="<?php echo $stateval['id']; ?>"><?php echo $stateval['first_name'] . ' ' . $stateval['middle_name'] . ' ' . $stateval['last_name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address1" id="address1" value="<?php if ($action == 'edit') {
                                                                                                        echo $address1;
                                                                                                    } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address2" id="address2" value="<?php if ($action == 'edit') {
                                                                                                        echo $address2;
                                                                                                    } ?>" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="zip" id="zip" value="<?php if ($action == 'edit') {
                                                                                                echo $zip;
                                                                                            } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mail_address1" id="mail_address1" value="<?php if ($action == 'edit') {
                                                                                                                    echo $mail_address1;
                                                                                                                } ?>" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mail_address2" id="mail_address2" value="<?php if ($action == 'edit') {
                                                                                                                    echo $mail_address2;
                                                                                                                } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="m_city" id="m_city" value="<?php if ($action == 'edit') {
                                                                                                    echo $m_city;
                                                                                                } ?>" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="m_zip" id="m_zip" value="<?php if ($action == 'edit') {
                                                                                                    echo $m_zip;
                                                                                                } ?>" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telephone" id="telephone" value="<?php if ($action == 'edit') {
                                                                                                            echo $telephone;
                                                                                                        } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="facsimile" id="facsimile" value="<?php if ($action == 'edit') {
                                                                                                            echo $facsimile;
                                                                                                        } ?>" class="form-control" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="demo-dp-range">
                                                <div class="input-daterange input-group" id="datepicker">
                                                    <input type="text" name="e_date" id="e_date" value="<?php if ($action == 'edit') {
                                                                                                            echo date(DATE_FORMAT, strtotime($e_date));
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="demo-dp-range">
                                                <div class="input-daterange input-group" id="datepicker">
                                                    <input type="text" name="i_date" id="i_date" value="<?php if ($action == 'edit' && $i_date != '1970-01-01') {
                                                                                                            echo date(DATE_FORMAT, strtotime($i_date));
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="tab_bb">
                                <div class="row">
                                    <div class="colmd-12">
                                        <h3 style="margin: 0px 20px 20px 0px; text-align:right;"><?php echo $company_name ?></h3>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="payout_level" id="payout_level" value="1" <?php if ($action == 'edit') {
                                                                                                                                        if ($payout_level == 1) { ?>checked="true" <?php }
                                                                                                                                                                            } ?> />Company/Practice Level
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="payout_level" id="payout_level" value="2" <?php if ($action == 'edit') {
                                                                                                                                        if ($payout_level == 2) { ?>checked="true" <?php }
                                                                                                                                                                            } ?> />Broker Level
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="sliding_scale_commision" id="sliding_scale_commision" value="1" <?php if ($action == 'edit') {
                                                                                                                                                            if ($sliding_scale_commision == 1) { ?>checked="true" <?php }
                                                                                                                                                                                                            } ?> />Payroll-to-Date Concession
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="sliding_scale_commision" id="sliding_scale_commision" value="2" <?php if ($action == 'edit') {
                                                                                                                                                            if ($sliding_scale_commision == 2) { ?>checked="true" <?php }
                                                                                                                                                                                                            } ?> />Year-to-Date Concession
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="sliding_scale_commision" id="sliding_scale_commision" value="3" <?php if ($action == 'edit') {
                                                                                                                                                            if ($sliding_scale_commision == 3) { ?>checked="true" <?php }
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="clearing_charge_calculation" id="clearing_charge_calculation" value="1" <?php if ($action == 'edit') {
                                                                                                                                                                    if ($clearing_charge_calculation == 1) { ?>checked="true" <?php }
                                                                                                                                                                                                                        } ?> />Gross Payout
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" class="radio" name="clearing_charge_calculation" id="clearing_charge_calculation" value="2" <?php if ($action == 'edit') {
                                                                                                                                                                    if ($clearing_charge_calculation == 2) { ?>checked="true" <?php }
                                                                                                                                                                                                                        } ?> />Net Payout
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="threshold1" id="threshold1" class="form-control" value="<?php if ($action == 'edit' && $threshold1 != '') {
                                                                                                                                    echo "$" . number_format($threshold1);
                                                                                                                                } ?>" maxlength="13" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" style="width: 130px;">
                                                <input type="text" name="l1_rate" id="l1_rate" value="<?php if ($action == 'edit'  && $l1_rate != '') {
                                                                                                            echo number_format($l1_rate, 2);
                                                                                                        } ?>" class="form-control" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="threshold2" id="threshold2" class="form-control" value="<?php if ($action == 'edit' && $threshold2 != '') {
                                                                                                                                    echo "$" . number_format($threshold2);
                                                                                                                                } ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Payout Rate </label>
                                            <div class="input-group" style="width: 130px;">
                                                <input type="text" name="l2_rate" id="l2_rate" value="<?php if ($action == 'edit' && $l2_rate != '') {
                                                                                                            echo number_format($l2_rate, 2);
                                                                                                        } ?>" class="form-control" />
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Threshold </label>
                                            <input type="text" name="threshold3" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="threshold3" value="<?php if ($action == 'edit' && $threshold3 != '') {
                                                                                                                                                                                echo "$" . number_format($threshold3);
                                                                                                                                                                            } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Payout Rate </label>
                                            <div class="input-group" style="width: 130px;">
                                                <input type="text" name="l3_rate" id="l3_rate" value="<?php if ($action == 'edit' && $l3_rate != '') {
                                                                                                            echo number_format($l3_rate, 2);
                                                                                                        } ?>" class="form-control" />
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Threshold </label>
                                            <input type="text" name="threshold4" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="threshold4" value="<?php if ($action == 'edit' && $threshold4 != '') {
                                                                                                                                                                                echo "$" . number_format($threshold4);
                                                                                                                                                                            } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Payout Rate </label>
                                            <div class="input-group" style="width: 130px;">
                                                <input type="text" name="l4_rate" id="l4_rate" value="<?php if ($action == 'edit' && $l4_rate != '') {
                                                                                                            echo number_format($l4_rate, 2);
                                                                                                        } ?>" class="form-control" />
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Threshold </label>
                                            <input type="text" name="threshold5" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="threshold5" value="<?php if ($action == 'edit' && $threshold5 != '') {
                                                                                                                                                                                echo "$" . number_format($threshold5);
                                                                                                                                                                            } ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Payout Rate </label>
                                            <div class="input-group" style="width: 130px;">
                                                <input type="text" name="l5_rate" id="l5_rate" value="<?php if ($action == 'edit' && $l5_rate != '') {
                                                                                                            echo number_format($l5_rate, 2);
                                                                                                        } ?>" class="form-control" />
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Threshold </label>
                                            <input type="text" name="threshold6" id="threshold6" value="<?php if ($action == 'edit' && $threshold6 != '') {
                                                                                                            echo "$" . number_format($threshold6);
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Payout Rate </label>
                                            <div class="input-group" style="width: 130px;">
                                                <input type="text" name="l6_rate" id="l6_rate" value="<?php if ($action == 'edit'  && $l6_rate != '') {
                                                                                                            echo number_format($l6_rate, 2);
                                                                                                        } ?>" class="form-control" />
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <?php if (isset($state) && $state != '') {
                                            $mystate = explode(',', $state);
                                        }

                                        foreach ($get_state as $statekey => $stateval) { ?>
                                            <label class="check-inline col-md-2">
                                                <input type="checkbox" style="display: inline;" class="checkbox" <?php if (isset($mystate) && in_array($stateval['id'], $mystate)) { ?>checked="true" <?php } ?> name="state[<?php echo $stateval['id']; ?>]" id="<?php echo $stateval['name']; ?>" value="<?php echo $stateval['id']; ?>" /><?php echo $stateval['name']; ?>
                                            </label>
                                        <?php } ?>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($multicompany_data as $key => $val) {
                                            ...
                                            <tr>
                                                ...
                                                <?php } else if ($feild_name == 'Clearing Charge Calculation') { ?>
                                                    <td>
                                                        <?php
                                                        if ($val['old_value'] == 1) {
                                                            echo 'Gross Payout';
                                                ...
                                                <?php } else if ($feild_name == 'Sliding Scale Commission Basis') { ?>
                                                    <td>
                                                        <?php
                                                        if ($val['old_value'] == 1) {
                                                ...
                                                <?php } else if ($feild_name == 'Manager Name') {
                                                    ...
                                                    <td><?php echo $manager_name['broker_name']; ?></td>
                                                <?php } else if ($feild_name == 'Product Category') {
...
<script>
    ...
    function check_Threshold() {
        ...
        if (thr2 > 0 && thr1 > 0 && thr2 < thr1) {
            warnmsg("Threshold2 must be greater then Threshold1");
            return false;
        }
        if (thr3 > 0 && thr2 > 0 && thr3 < thr2) {
            warnmsg("Threshold3 must be greater then Threshold2");
            return false;
        }
        if (thr4 > 0 && thr3 > 0 && thr4 < thr3) {
            warnmsg("Threshold4 must be greater then Threshold3");
            return false;
        }
        if (thr5 > 0 && thr4 > 0 && thr5 < thr4) {
            warnmsg("Threshold5 must be greater then Threshold4");
            return false;
        }
        if (thr6 > 0 && thr5 > 0 && thr6 < thr5) {
            warnmsg("Threshold6 must be greater then Threshold5");
            return false;
        }
        waitingDialog.show()
        return true;
