                ...
                ?>
                    <form method="post">
                        <div class="tab-content">
                                    ...
                                    <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="demo-dp-range">
                                                        <div class="input-daterange input-group" id="datepicker">
                                                            <input type="text" name="trade_date" id="trade_date" class="form-control" value="<?php if ($trade_date != '' && $trade_date != '0000-00-00') {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="client_name" id="client_name">
                                                        ...
                                                        <?php foreach ($get_client as $key => $val) { ?>
                                                            <option value="<?php echo $val['id']; ?>" <?php if ($client_name != '' && $client_name == $val['id']) {
                                                                                                            echo "selected='selected'";
                                                                                                        } ?>><?php echo $val['first_name'] . ' ' . $val['last_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div id="demo-dp-range">
                                                        <div class="input-daterange input-group" id="datepicker">
                                                            <input type="text" name="date_received" id="date_received" class="form-control" value="<?php if ($date_received != '' && $date_received != '0000-00-00') {
                                                                                                                                                        echo date('m/d/Y', strtotime($date_received));
                                                                                                                                                    } ?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <select class="form-control" name="split_broker[]">
                                                                    ...
                                                                    <?php foreach ($get_broker as $key => $val) { ?>
                                                                        <option value="<?php echo $val['id']; ?>" <?php if ($splits_val['split_broker'] != '' && $splits_val['split_broker'] == $val['id']) {
                                                                                                                        echo "selected='selected'";
                                                                                                                    } ?>><?php echo $val['first_name'] . ' ' . $val['middle_name'] . ' ' . $val['last_name']; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                        ...
                                        if (isset($return_trade_overrides) && $return_trade_overrides != array()) { ?>
                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="form-group">
                                                                        <select class="form-control" name="override_broker[]">
                                                                            <option value="">Select Broker</option>
                                                                            <?php foreach ($get_broker as $key => $val) { ?>
                                                                                <option value="<?php echo $val['id']; ?>" <?php if ($overrides_val['receiving_rep'] != '' && $overrides_val['receiving_rep'] == $val['id']) {
                                                                                                                                echo "selected='selected'";
                                                                                                                            } ?>><?php echo $val['first_name'] . ' ' . $val['middle_name'] . ' ' . $val['last_name']; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                ...
                                                <!--<div class="col-md-2">
                                            <input type="radio" class="radio" name="buy_sell" id="buy" style="display: inline;" value="1" <?php if ($buy_sell == 1) {
                                                                                                                                                echo "checked='checked'";
                                                                                                                                            } ?>/> Buy&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <input type="radio" class="radio" name="buy_sell" id="sell" style="display: inline;" value="2" <?php if ($buy_sell == 2) {
                                                                                                                                                echo "checked='checked'";
                                                                                                                                            } ?>/> Sell<br /><br />
                                            <input type="checkbox" class="checkbox" name="hold" id="hold" style="display: inline;" value="1"  <?php if ($hold == 1) {
                                                                                                                                                    echo "checked='checked'";
                                                                                                                                                } ?>/> Hold<br />
                                            <input type="text" name="hold_reason" id="hold_reason" class="form-control amount" value="<?php echo $hold_reason; ?>" /><br />
                                            <input type="checkbox" class="checkbox" name="cancel" id="cancel" style="display: inline;" value="1"  <?php if ($cancel == 1) {
                                                                                                                                                        echo "checked='checked'";
                                                                                                                                                    } ?>/> Cancel<br />
                                        </div>-->
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="hold_reason" id="hold_reason" style="<?php if ($hold != 1) {
                                                                                                                    echo "display:none";
                                                                                                                } ?>" class="form-control amount" value="<?php echo $hold_reason; ?>" />
                                            </div>
                                            <div class="col-md-4">
                                                <input type="checkbox" class="checkbox" name="cancel" id="cancel" style="display: inline;" value="1" <?php if ($cancel == 1) {
                                                                                                                                                            echo "checked='checked'";
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="branch" id="branch" onchange="get_branch_company(this.value)">
                                                        ...
                                                        <?php foreach ($get_branch as $key => $val) { ?>
                                                            <option value="<?php echo $val['id']; ?>" <?php if (isset($branch) && $branch == $val['id']) {
                                                                                                            echo "selected='selected'";
                            ...
                            <div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "transactions") {
                                                        echo "active";
                                                    } else {
                                                        echo '';
                                                    } ?>" id="tab_transactions">
                                ...
                                <table id="data-table" class="table table-striped1 table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($return as $key => $val) {
                                            $reviewpayrollEditLink = CURRENT_PAGE . "?action=edit&id=" . $val['id'];
                                        ?>
                                            <tr>
                                                ...
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['trade_number']; ?></td>
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php if (isset($val['trade_date']) && $val['trade_date'] != '0000-00-00') {
                                                                                                                                                                                echo date('m/d/Y', strtotime($val['trade_date']));
                                                                                                                                                                            } else {
                                                                                                                                                                                echo '';
                                                                                                                                                                            } ?></td>

                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['client_firstname'] . ' ' . $val['client_lastname']; ?></td>
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['client_account_number']; ?></td>
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['broker_firstname'] . ' ' . $val['broker_lastname']; ?></td>
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['investment_amount']; ?></td>
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['commission_received']; ?></td>
                                                <td onclick="waitingDialog.show('a'),window.location.href='<?php echo $reviewpayrollEditLink ?>'" style="cursor:pointer"><?php echo $val['commission_paid']; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
