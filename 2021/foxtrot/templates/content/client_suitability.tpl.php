<div class="container">
    ...
    <div class="col-lg-12 well">
        ...
        <ul class="nav nav-pills nav-stacked col-md-2">
            <li <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_objective') || (isset($_GET['action']) && $_GET['action'] == 'view_objective') || (isset($_GET['action']) && $_GET['action'] == 'edit_objective')) { ?> class="active" <?php }
                                                                                                                                                                                                                                                    if ($action == 'view_objective') { ?>class="active" <?php } ?>><a href="client_suitability.php?action=view_objective">Objective</a></li>
            <li <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_income') || (isset($_GET['action']) && $_GET['action'] == 'view_income') || (isset($_GET['action']) && $_GET['action'] == 'edit_income')) { ?> class="active" <?php }
                                                                                                                                                                                                                                            if ($action == 'view_income') { ?>class="active" <?php } ?>><a href="client_suitability.php?action=view_income">Income</a></li>
        ...
        <div class="tab-content col-md-10">
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_objective') || (isset($_GET['action']) && $_GET['action'] == 'view_objective') || $action == 'view_objective' || (isset($_GET['action']) && $_GET['action'] == 'edit_objective')) { ?>active<?php } ?>" id="tab_l">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_objective') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_objective' || $action == 'view_objective') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_income') || (isset($_GET['action']) && $_GET['action'] == 'view_income') || $action == 'view_income' || (isset($_GET['action']) && $_GET['action'] == 'edit_income')) { ?>active<?php } ?>" id="tab_a">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_income') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_income' || $action == 'view_income') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_horizon') || (isset($_GET['action']) && $_GET['action'] == 'view_horizon') || (isset($_GET['action']) && $_GET['action'] == 'edit_horizon')) { ?>active<?php } ?>" id="tab_b">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_horizon') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_horizon') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_networth') || (isset($_GET['action']) && $_GET['action'] == 'view_networth') || (isset($_GET['action']) && $_GET['action'] == 'edit_networth')) { ?>active<?php } ?>" " id=" tab_c">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_networth') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_networth') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_risk_tolerance') || (isset($_GET['action']) && $_GET['action'] == 'view_risk_tolerance') || (isset($_GET['action']) && $_GET['action'] == 'edit_risk_tolerance')) { ?>active<?php } ?>" id="tab_d">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_risk_tolerance') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_risk_tolerance') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_annual_expenses') || (isset($_GET['action']) && $_GET['action'] == 'view_annual_expenses') || (isset($_GET['action']) && $_GET['action'] == 'edit_annual_expenses')) { ?>active<?php } ?>" id="tab_e">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_annual_expenses') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_annual_expenses') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_liqudity_needs') || (isset($_GET['action']) && $_GET['action'] == 'view_liqudity_needs') || (isset($_GET['action']) && $_GET['action'] == 'edit_liqudity_needs')) { ?>active<?php } ?>" id="tab_f">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_liqudity_needs') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_liqudity_needs') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_liquid_net_worth') || (isset($_GET['action']) && $_GET['action'] == 'view_liquid_net_worth') || (isset($_GET['action']) && $_GET['action'] == 'edit_liquid_net_worth')) { ?>active<?php } ?>" id="tab_g">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_liquid_net_worth') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_liquid_net_worth') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_special_expenses') || (isset($_GET['action']) && $_GET['action'] == 'view_special_expenses') || (isset($_GET['action']) && $_GET['action'] == 'edit_special_expenses')) { ?>active<?php } ?>" id="tab_h">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_special_expenses') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_special_expenses') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_portfolio') || (isset($_GET['action']) && $_GET['action'] == 'view_portfolio') || (isset($_GET['action']) && $_GET['action'] == 'edit_portfolio')) { ?>active<?php } ?>" id="tab_i">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_portfolio') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_portfolio') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                                <div class="panel-control">
                                    <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_time_for_exp') || (isset($_GET['action']) && $_GET['action'] == 'view_time_for_exp') || (isset($_GET['action']) && $_GET['action'] == 'edit_time_for_exp')) { ?>active<?php } ?>" id="tab_j">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_time_for_exp') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_time_for_exp') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                            <div class="panel-control">
                                <div class="btn-group dropdown" style="float: right;">
            ...
            <div class="tab-pane <?php if ((isset($_GET['action']) && $_GET['action'] == 'add_new_account_use') || (isset($_GET['action']) && $_GET['action'] == 'view_account_use') || (isset($_GET['action']) && $_GET['action'] == 'edit_account_use')) { ?>active<?php } ?>" id="tab_k">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Option <span class="text-red">*</span></label>
                                                    <input type="text" name="option" id="type" value="<?php if ($action == 'edit_account_use') {
                                                                                                            echo $option;
                                                                                                        } ?>" class="form-control" />
                                                </div>
                                            </div>
                ...
                <?php }
                if (isset($_GET['action']) == '' || $_GET['action'] == 'view_account_use') { ?>
                    <div class="panel">
                        <!--<div class="panel-heading">
                            <div class="panel-control">
                                <div class="btn-group dropdown" style="float: right;">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#data-table1_filter [type='search']").focus();
        ...
        $("#data-table2_filter [type='search']").focus();
        ...
        $("#data-table3_filter [type='search']").focus();
        ...
        $("#data-table4_filter [type='search']").focus();
        ...
        $("#data-table5_filter [type='search']").focus();
        ...
        $("#data-table6_filter [type='search']").focus();
        ...
        $("#data-table7_filter [type='search']").focus();
        ...
        $("#data-table8_filter [type='search']").focus();
        ...
        $("#data-table9_filter [type='search']").focus();
        ...
        $("#data-table10_filter [type='search']").focus();
        ...
        $("#data-table11_filter [type='search']").focus();
        ...
        $("#data-table12_filter [type='search']").focus();
