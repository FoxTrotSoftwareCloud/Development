...
elseif ($report_for == "monthly_broker_production") :
    ...
    if (!empty($rows) && !empty($rows['unique_category'])) {
        ...
        $sheet_data[0]['C' . $row_count] = array('Category Total', array('bold', 'right', 'color' => array('000000'), 'size' => array(15), 'font_name' => array('Calibri')));

        $row_count++;

        $sheet_data[0]['B' . $row_count] = array('PRODUCT CATEGORY', array('right', 'color' => array('000000'), 'background' => array('f1f1f1'), 'size' => array(10), 'font_name' => array('Calibri')));
        $sheet_data[0]['C' . $row_count] = array('TOTAL INVESTMENT AMOUNT', array('right', 'color' => array('000000'), 'background' => array('f1f1f1'), 'size' => array(10), 'font_name' => array('Calibri')));
        $sheet_data[0]['D' . $row_count] = array('TOTAL COMMISSION RECEIVED', array('right', 'color' => array('000000'), 'background' => array('f1f1f1'), 'size' => array(10), 'font_name' => array('Calibri')));
        $sheet_data[0]['E' . $row_count] = array('TOTAL NET COMMISSION', array('right', 'color' => array('000000'), 'background' => array('f1f1f1'), 'size' => array(10), 'font_name' => array('Calibri')));

        $row_count++;

        foreach ($rows['unique_category'] as $cat) {
            $sheet_data[0]['B' . $row_count] = array($cat['product_cat_name'], array('bold', 'right', 'color' => array('000000'), 'size' => array(10), 'font_name' => array('Calibri')));
            $sheet_data[0]['C' . $row_count] = array(number_format($cat['total_investment'], 2), array('right', 'color' => array('000000'), 'size' => array(10), 'font_name' => array('Calibri')));
            $sheet_data[0]['D' . $row_count] = array(number_format($cat['total_commission_received'], 2), array('right', 'color' => array('000000'), 'size' => array(10), 'font_name' => array('Calibri')));
            $sheet_data[0]['E' . $row_count] = array(number_format($cat['net_commission'], 2), array('right', 'color' => array('000000'), 'size' => array(10), 'font_name' => array('Calibri')));
            $row_count++;
        }
    } else {
        $row_count++;
