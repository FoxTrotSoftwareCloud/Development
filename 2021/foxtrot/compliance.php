...
if (isset($_POST['submit']) && $_POST['submit'] == 'Proceed') {
    ...
    if ($report_for == 1) { 
        if ($output == 1) {
            ...
            header("location:" . SITE_URL . "report_client_ac_pdf.php?open=output_print&filter=" . $data_array);
            exit;
        } else if ($output == 3) {

            header("location:" . SITE_URL . "report_client_review_excel.php?filter=" . $data_array);
            exit;
        } else if ($output == 4) {

            header("location:" . SITE_URL . "report_client_ac_pdf.php?filter=" . $data_array);
            exit;
        }
        ...
        if ($output == 1) {
            ...
            header("location:" . SITE_URL . "report_client_review_pdf.php?open=output_print&filter=" . $data_array);
            exit;
        } else if ($output == 3) {

            header("location:" . SITE_URL . "report_batch_excel.php?filter=" . $data_array);
            exit;
        } else if ($output == 4) {

            header("location:" . SITE_URL . "report_client_review_pdf.php?filter=" . $data_array);
            exit;
        }
        ...
        if ($output == 1) {
            ...
            header("location:" . SITE_URL . "report_broker_state_license_pdf.php?open=output_print&filter=" . $data_array);
            exit;
        } else if ($output == 3) {

            header("location:" . SITE_URL . "report_broker_state_license_excel.php?filter=" . $data_array);
            exit;
        } else if ($output == 4) {

            header("location:" . SITE_URL . "report_broker_state_license_pdf.php?filter=" . $data_array);
            exit;
        }
        ...
        if ($output == 1) {
            ...
            header("location:" . SITE_URL . "report_complience_exception_pdf.php?open=output_print&filter=" . $data_array);
            exit;
        } else if ($output == 3) {

            header("location:" . SITE_URL . "report_complience_exception_excel.php?filter=" . $data_array);
            exit;
        } else if ($output == 4) {

            header("location:" . SITE_URL . "report_complience_exception_pdf.php?filter=" . $data_array);
            exit;
        }
        ...
        if ($output == 1) {
            ...
            header("location:" . SITE_URL . "report_broker_sponsor_appointment_pdf.php?open=output_print&filter=" . $data_array);
            exit;
        } else if ($output == 3) {

            header("location:" . SITE_URL . "report_broker_sponsor_appointment_excel.php?filter=" . $data_array);
            exit;
        } else if ($output == 4) {

            header("location:" . SITE_URL . "report_broker_sponsor_appointment_pdf.php?filter=" . $data_array);
            exit;
        }
        ...
        if ($output == 1) {
            ...
            header("location:" . SITE_URL . "report_client_cip_pdf.php?open=output_print&filter=" . $data_array);
            exit;
        } else if ($output == 3) {
            header("location:" . SITE_URL . "report_client_cip_excel.php?filter=" . $data_array);
            exit;
        } else if ($output == 4) {

            header("location:" . SITE_URL . "report_client_cip_pdf.php?filter=" . $data_array);
            exit;
        }
    }
}
