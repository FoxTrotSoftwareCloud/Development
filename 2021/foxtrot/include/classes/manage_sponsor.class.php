<?php
	class manage_sponsor extends db{
        ...
        public function insert_update_sponsor($data)
        {
          ...
          $sponsor_name = isset($data['sponsor_name'])?$this->re_db_input($data['sponsor_name']):'';
          ...
          $q = "SELECT * FROM `".SPONSOR_MASTER."` WHERE `is_delete`='0' AND `name`='".$sponsor_name."' ".$con;
        ...
        public function insert_update_sponsor_notes($data){
