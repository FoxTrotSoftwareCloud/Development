...
class broker_master extends db
{
    ...
    public function insert_update($data)
    {
        ...
        {
            $ssn = (int)str_replace('-', '', $this->re_db_input($data['ssn']));
        }

        $tax_id = 0;
        if (isset($data['tax_id']) && $data['tax_id'] != '')
        {
            $tax_id = (int)str_replace('-', '', $this->re_db_input($data['tax_id']));
        }

        $crd = '';
        if (isset($data['crd']) && $data['crd'] != '')
        {
            $crd = $this->re_db_input($data['crd']);
        }

        $active_status_cdd = 0;
        if (isset($data['active_status_cdd']) && $data['active_status_cdd'] != '')
        {
            $active_status_cdd = (int)$this->re_db_input($data['active_status_cdd']);
        }

        $pay_method = 0;
        if (isset($data['pay_method']) && $data['pay_method'] != '')
        {
            $pay_method = (int)$this->re_db_input($data['pay_method']);
        }
        ...
        else
        {
            ...
            else
            {
                if ($id == 0)
                {
                    ...
                    `fund`='" . $fund . "',
                    `internal`='" . $internal . "',
                    `display_on_statement`='" . $display_on_statement . "',
                    `tax_id`='" . $tax_id . "',
                    `crd`='" . $crd . "',
                    `ssn`='" . $ssn . "',
                    `modified_by`=0,
                    ...
                    `modified_ip`='',
                    `active_status`='" . $active_status_cdd . "',
                    `pay_method`='" . $pay_method . "'" . $this->insert_common_sql();
                    $res = $this->re_db_query($q);
    ...
    public function insert_update_general($data)
    {
        ...
        $home_general = 0;
        if (isset($data['home_general']) && $data['home_general'] != '')
        {
            $home_general = (int) $this->re_db_input($data['home_general']);
        }

        $state_general = 0;
        if (isset($data['state_general']) && $data['state_general'] != '')
        {
            $state_general = (int) $this->re_db_input($data['state_general']);
        }

        $zip_code_general = 0;
        if (isset($data['zip_code_general']) && $data['zip_code_general'] != '')
        {
            $zip_code_general = (int) $this->re_db_input($data['zip_code_general']);
        }

        $web_id_general = 0;
        if (isset($data['web_id_general']) && $data['web_id_general'] != '')
        {
            $web_id_general = (int) $this->re_db_input($data['web_id_general']);
        }

        $reassign_broker_general = 0;
        if (isset($data['reassign_broker_general']) && $data['reassign_broker_general'] != '')
        {
            $reassign_broker_general = (int) $this->re_db_input($data['reassign_broker_general']);
        }
        ...
        else if ($id >= 0)
        {
            if ($id == 0)
            {
                $q = "INSERT INTO `" . BROKER_GENERAL . "` SET
                `broker_id`='" . $_SESSION['last_insert_id'] . "',
                `home`='" . $home_general . "',
                `home_address1_general`='" . $home_address1_general . "',
                `home_address2_general`='" . $home_address2_general . "',
                `business_address1_general`='" . $business_address1_general . "',
                `business_address2_general`='" . $business_address2_general . "',
                `city`='" . $city_general . "',
                `state_id`='" . $state_general . "',
                `zip_code`='" . $zip_code_general . "',
                `telephone`='" . $telephone_general . "',
                `cell`='" . $cell_general . "',
                `fax`='" . $fax_general . "',
                `gender`='" . $gender_general . "',
                `marital_status`='" . $status_general . "',
                `spouse`='" . $spouse_general . "',
                `children`='" . $children_general . "',
                `email1`='" . $email1_general . "',
                `email2`='" . $email2_general . "',
                `web_id`='" . $web_id_general . "',
                `web_password`='" . $web_password_general . "',
                `dob`='" . $dob_general . "',
                `prospect_date`='" . $prospect_date_general . "',
                `reassign_broker`='" . $reassign_broker_general . "',
                `u4`='" . $u4_general . "',
                `u5`='" . $u5_general . "',
                `day_after_u5`='" . $day_after_u5 . "',
                `dba_name`='" . $dba_name_general . "',
                `eft_information`='" . $eft_info_general . "',
                `start_date`='" . $start_date_general . "',
                `transaction_type`='" . $transaction_type_general . "',
                `routing`='" . $routing_general . "',
                `account_no`='" . $account_no_general . "',
                `cfp`='" . $cfp_general . "',
                `chfp`='" . $chfp_general . "',
                `cpa`='" . $cpa_general . "',
                `clu`='" . $clu_general . "',
                `cfa`='" . $cfa_general . "',
                `ria`='" . $ria_general . "',
                `hold_commissions_from`='0000-00-00',
                `hold_commissions_to`='0000-00-00',
                `modified_by`=0,
                `modified_time`='0000-00-00',
                `modified_ip`='',
                `insurance`='" . $insurance_general . "'" . $this->insert_common_sql();
    ...
    public function insert_update_payout_grid($data, $id)
    {
        ...
        if ($id == 0)
        {
            foreach ($data as $key => $val)
            {
                ...
                if ($from != '' && $to != '' && $per != '')
                {
                    $q = "INSERT INTO `" . BROKER_PAYOUT_GRID . "` SET
                                `broker_id`='" . $_SESSION['last_insert_id'] . "',
    ...
    public function insert_update_payout_fixed_rates($data, $id)
    {
        ...
        if ($id == 0)
        {
            ...
            {
                $category_rates = isset($data['category_rates_' . $val]) ? $data['category_rates_' . $val] : '';
                $q = "INSERT INTO `" . PAYOUT_FIXED_RATES . "` SET
                           `broker_id`='" . $_SESSION['last_insert_id'] . "',
                           `category_id`='" . $val . "',
                           `modified_time`='0000-00-00',
                           `modified_by`=0,
                           `modified_ip`='',
                           `category_rates`='" . $category_rates . "'" . $this->insert_common_sql();
                $res = $this->re_db_query($q);
            }
        }
        else
    ...
    public function insert_update_payout($data)
    {
        ...
        $calculation_detail = isset($data['calculation_detail']) ? $this->re_db_input($data['calculation_detail']) : 0;
        ...
        $product_3 = isset($data['product_3']) ? $this->re_db_input($data['product_3']) : 0;
        $product_4 = isset($data['product_4']) ? $this->re_db_input($data['product_4']) : 0;
        $product_5 = isset($data['product_5']) ? $this->re_db_input($data['product_5']) : 0;
        $calculate_on = isset($data['calculate_on']) ? $this->re_db_input($data['calculate_on']) : 0;
        $deduct = isset($data['deduct']) ? $this->re_db_input($data['deduct']) : 0;
        ...
        if ($id >= 0)
        {
            ...
            if ($record == 0)
            {
                $q = "INSERT INTO `" . BROKER_PAYOUT_MASTER . "` SET
                        `broker_id`='" . $_SESSION['last_insert_id'] . "',
                        ...
                        `reset`='" . $reset . "',`description_type`='" . $description_type . "',
                        ...
                        `modified_time`='0000-00-00',
                        `modified_ip`='',
                        `summarize_12B1_from_autoposting`='" . $summarize_12B1_from_autoposting . "'" . $this->insert_common_sql();
                $res = $this->re_db_query($q);
        ...
        if ($id >= 0)
        {
            ...
            if ($id == 0)
            {
                foreach ($data['data1'] as $key => $val)
                {
                    ...
                    $q = "INSERT INTO `" . BROKER_LICENCES_SECURITIES . "` SET
                        `broker_id`='" . $_SESSION['last_insert_id'] . "',
                        ...
                        `modified_time`='0000-00-00',
                        `modified_ip`='',
                        `reson`='" . $reason . "' " . $this->insert_common_sql();
                    $res = $this->re_db_query($q);
                }
        ...
        if ($id >= 0)
        {
            if ($id == 0)
            {
                foreach ($data['data2'] as $key => $val)
                {
                    ...
                    $q = "INSERT INTO `" . BROKER_LICENCES_INSURANCE . "` SET
                `broker_id`='" . $_SESSION['last_insert_id'] . "',
                `type_of_licences`='" . $type_of_licences . "',
                `state_id`='" . $key . "', 
                `waive_home_state_fee`='" . $waive_home_state_fee . "',
        ...
        if ($id >= 0)
        {
            if ($id == 0)
            {
                foreach ($data['data3'] as $key => $val)
                {
                    ...
                    $q = "INSERT INTO `" . BROKER_LICENCES_RIA . "` SET
                        `broker_id`='" . $_SESSION['last_insert_id'] . "',
                        `type_of_licences`='" . $type_of_licences . "',
                        `state_id`='" . $key . "',
                        `waive_home_state_fee`='" . $waive_home_state_fee . "',
        ...
        if ($id >= 0)
        {
            if ($id == 0)
            {
                foreach ($data['data4'] as $key => $val)
                {
                    ...
                    $q = "INSERT INTO `" . BROKER_REGISTER_MASTER . "` SET
                        `broker_id`='" . $_SESSION['last_insert_id'] . "',
                        `license_id`='" . $key . "' ,`license_name`='" . $type . "',
                        `approval_date`='" . $approval_date . "',
                        `expiration_date`='" . $expiration_date . "',
                        `modified_by`=0,
                        `modified_time`='0000-00-00',
                        `modified_ip`='',
                        `reason`='" . $register_reason . "' " . $this->insert_common_sql();
                    $res = $this->re_db_query($q);
                }
                if ($res)
                {
                ...
                foreach ($type_vale as $name_id => $name_val)
                {
                    foreach ($name_val as $accout_type => $account_val)
                    {
                        foreach ($account_val as $account_process => $value)
                        {
                            ...
                            {
                                $r = $this->re_db_query("INSERT INTO ft_charge_value SET
                                                             charge_detail_id='" . $row['charge_detail_id'] . "',
                                                             broker_id='" . $id . "',
                                                             none_check = '" . $pass_through . "',
                                                             modified_by=0,
                                                             modified_time='0000-00-00',
                                                             modified_ip='',
                                                             VALUE='" . $value . "'" . $this->insert_common_sql());
                            }
                        }
                    }
    ...
    public function insert_update_branches($data)
    {
        ...
        $branch_1 = 0;
        if (isset($data['branch_1']) && $data['branch_1'] != '')
        {
            $branch_1 = (int)$this->re_db_input($data['branch_1']);
        }

        $branch_office_1 = 0;
        if (isset($data['branch_office_1']) && $data['branch_office_1'] != '')
        {
            $branch_office_1 = (int)$this->re_db_input($data['branch_office_1']);
        }

        $branch_2 = 0;
        if (isset($data['branch_2']) && $data['branch_2'] != '')
        {
            $branch_2 = (int)$this->re_db_input($data['branch_2']);
        }

        $branch_office_2 = 0;
        if (isset($data['branch_office_2']) && $data['branch_office_2'] != '')
        {
            $branch_office_2 = (int)$this->re_db_input($data['branch_office_2']);
        }

        $branch_3 = 0;
        if (isset($data['branch_3']) && $data['branch_3'] != '')
        {
            $branch_3 = (int)$this->re_db_input($data['branch_3']);
        }

        $branch_office_3 = 0;
        if (isset($data['branch_office_3']) && $data['branch_office_3'] != '')
        {
            $branch_office_3 = (int)$this->re_db_input($data['branch_office_3']);
        }
        ...
        if ($id == 0)
        {
            $q = "INSERT INTO `" . BROKER_BRANCHES . "` SET
            `broker_id`='" . $_SESSION['last_insert_id'] . "',
            `broker_name`='" . $branch_broker . "',
            `branch1`='" . $branch_1 . "',
            `branch_office1`='" . $branch_office_1 . "',
            `branch2`='" . $branch_2 . "',
            `branch_office2`='" . $branch_office_2 . "',
            `branch3`='" . $branch_3 . "',
            `branch_office3`='" . $branch_office_3 . "',
            `assess_branch_office_fee`='" . $assess_branch_office_fee . "',
            `assess_audit_fee`='" . $assess_audit_fee . "',
            `stamp`='" . $stamp . "',
            `stamp_certification`='" . $stamp_certification . "',
            `modified_by`=0,
            `modified_time`='0000-00-00',
            `modified_ip`='',
            `stamp_indemnification`='" . $stamp_indemnification . "'" . $this->insert_common_sql();
            $res = $this->re_db_query($q);
            if ($res)
            {
                $_SESSION['success'] = INSERT_MESSAGE;
