<?php
    ...
    if(isset($_GET['filter']) && $_GET['filter'] != '')
    {
        ...
        $return = $instance->get_payable_report($product_category,$company,$batch,$cuttoff_date,$sort_by,$payable_type);
    ...
    $company_data= $company_name. " PAYABLES REPORT ".$enter_char." TRADE WITH ".$payable_type_text." ".$enter_char." Cutoff -".$cuttoff_date;    
    ...
    $sheet_data = array( // Set sheet data.
        ...
        array(
            ...
            'B1'=>array($company_data,array('bold','center','color'=>array('000000'),'size'=>array(14),'font_name'=>array('Calibri'),'merge'=>array('B1','F2'))),
            ...
            'B4'=>array('CLIENT',array('bold','center','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
            'C4'=>array('PRODUCT',array('bold','center','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
            'D4'=>array('INVESTMENT AMOUNT',array('bold','center','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
            ...
            'F4'=>array('CHARGE',array('bold','center','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
            'G4'=>array('BROKER PAYOUT',array('bold','center','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
        ...
        if(is_array($return) && count($return)>0)
        {
            foreach($return as $trans_main_key=>$trans_main_data)
            {
                ...
                foreach($trans_main_data as $key=>$val){
                    ...
                    $payable_flat_rate = isset($val["rates"]) && !empty($val["rates"]) ? $val["rates"] : 100;
                    $payable_amount = ($val['commission_received'] * $payable_flat_rate) / 100;
                    $total_payable_charges=($total_payable_charges+$payable_amount);
                    $sub_payable_charges=$sub_payable_charges+$payable_amount;
                    $val['product_name'] = !empty($val['transaction_id']) ? "*".$val['product_name']: $val['product_name'];
                    ...
                    if($val['commission_received_date'] != '0000-00-00'){ $commission_received_date = date('m/d/Y',strtotime($val['commission_received_date'])); }
                        ...
                        $sheet_data[0]['A'.$i] = array($trade_date,array('center','color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                          $sheet_data[0]['B'.$i] = array($instance->re_db_output($val['client_name']),array('center','color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                        ...
                        $sheet_data[0]['E'.$i] = array($instance->re_db_output('$'.number_format($val['commission_received'],2)),array('right','color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                         $sheet_data[0]['F'.$i] = array($instance->re_db_output('$'.number_format($val['charge_amount'],2)),array('right','color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                        $sheet_data[0]['G'.$i] = array($payable_amount,array('right','color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                ...
                $i++;
                $sheet_data[0]['A'.$i] = array("*   ".$broker_name."  TOTAL *",array('bold','right','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'),'merge'=>array('A'.$i,'B'.$i,'C'.$i)));
                
                $sheet_data[0]['D'.$i] = array($instance->re_db_output('$'.number_format($sub_total_amount_invested,2)),array('bold','right','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri')));
                $sheet_data[0]['E'.$i] = array($instance->re_db_output('$'.number_format($sub_total_commission_received,2)),array('bold','right','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri')));
                $sheet_data[0]['F'.$i] = array($instance->re_db_output('$'.number_format($sub_total_charges,2)),array('bold','right','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri')));
                 $sheet_data[0]['G'.$i] = array($instance->re_db_output('$'.number_format($sub_payable_charges,2)),array('bold','right','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri')));
            }
            $i++;
            ...
            $sheet_data[0]['G'.$i] = array($instance->re_db_output('$'.number_format($total_payable_charges,2)),array('bold','right','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri')));
