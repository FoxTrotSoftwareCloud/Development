...
<head>
    ...
    <style>
	 ...
	 width: 1500px;
        ...
        .userinfo {
            margin: -40px 0px 0 -560px;
            /*margin: -40px 0px 0 220px;/* 89 when use menu icon*/
        }
                            ...
                            <div class="collapse navbar-collapse" id="myNavbar">
                                ...
                                <ul class="nav navbar-nav" style="margin: 30px 0px 0px 0px;">
                                    ...
                                    <li class="dropdown" style="float: right;">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #ef7623;font-weight: 500;font-size: 18px;padding: 0;text-transform: capitalize;"><?php if (isset($_SESSION['user_name'])) {
