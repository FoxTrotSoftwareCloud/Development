...
$get_webcrd_data = $instance->select_registration_status_data($webcrd_main_id, 1, 1);
...
<?php
    ...
    $html='<table border="0">
                <tr>
                    <td width="100%" style="font-size:14px;font-weight:bold;text-align:center;">WebCRD Registration Status Report</td>
                </tr>
           </table>';
    $pdf->writeHTML($html, false, 0, false, 0);
    $pdf->Ln(2);
    ...
    $html='<table border="0" cellpadding="1" width="100%">
                <tr style="background-color: #f1f1f1;">
                    ...
                    <td style="text-align:left;width:10%"><h5>CATEGORY CODE</h5></td>
                    <td style="text-align:left;width:10%"><h5>REGULATOR CODE</h5></td>
                    <td style="text-align:left;width:10%"><h5>STATUS</h5></td>
                    <td style="text-align:center;width:10%"><h5>STATUS TYPE</h5></td>
                    <td style="text-align:center;width:10%"><h5>STATUS DATE</h5></td>
                ...
                if($get_webcrd_data != [])
                {
                    foreach($get_webcrd_data as $key=>$val)
                    {
                        ...
                        $html.='<tr>
                           ...
                           <td style="font-size:8px;font-weight:normal;text-align:left;">'.$val['registration_category_code'].'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:left;">'.$val['regulator_code'].'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:left;">'.$val['registration_status_name'].'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:center;">'.$val['registration_status_type_code'].'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:center;">'.$val['current_status_date'].'</td>
    ...
    if(isset($_GET['open']) && $_GET['open'] == 'webcrd_registration_status_print')
    {
        $pdf->IncludeJS("print();");
    }
    $pdf->Output('report_webcrd_registration_status.pdf', 'I');
