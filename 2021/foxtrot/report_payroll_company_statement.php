...
<?php
    ...
    $html='<table border="0" width="100%">
        ...
        $html .='</tr>';
        $html .= '<tr><td width="100%" colspan="3" style="font-size:12px;font-weight:bold;text-align:center;">'.$payroll_date.'</td></tr>';
    $html .= '</table>';
        ...
        {//echo '<pre>'print_r($get_company_data);exit;
            ...
            foreach($com_data as $com_sub_key=>$com_sub_data)
            {
                ...
                $html.='<tr>
                           ...
                           <td style="font-size:8px;font-weight:normal;text-align:right;">'.number_format($com_sub_data['commission_received'],2).'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:right;">'.number_format($com_sub_data['commission_paid'],2).'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:right;">'.$com_sub_data['charge'].'</td>
                           <td style="font-size:8px;font-weight:normal;text-align:right;">'.$com_sub_data['override_paid'].'</td>
