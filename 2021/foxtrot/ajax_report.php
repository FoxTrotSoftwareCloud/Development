    ...
    ?>
        <table border="0" width="100%">
            ...
            <tr>
                <?php if ($batch > 0) { ?>
                    <th colspan="9">
                        <h4 style="text-align: center;">Batch #<?php echo $batch; ?></h4>
                    </th>
                <?php } ?>
            </tr>
        </table>
        ...
        <table border="0" cellpadding="1" width="100%">
            ...
            <tbody>
                ...
                ?>
                        ...
                        ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="font-size:10px;font-weight:normal;text-align:center;"><?php if ($trans_data['trade_date'] != '0000-00-00') {
                                                                                                            echo date('m/d/Y', strtotime($trans_data['trade_date']));
                                                                                                        } ?></td>
                                    <td style="font-size:10px;font-weight:normal;text-align:center;"><?php if ($trans_data['commission_received_date'] != '0000-00-00') {
                                                                                                            echo date('m/d/Y', strtotime($trans_data['commission_received_date']));
                                                                                                        } ?></td>
                        ...
                        <?php $total_batch_amount_invested = $total_batch_amount_invested + $sub_total_amount_invested;
                        ...
                        <tr style="background-color: #f1f1f1;">
                            ...
                            <td style="font-size:10px;font-weight:bold;text-align:right;" colspan="5">*** Batch TOTALS *** </td>
                            <td style="font-size:10px;font-weight:bold;text-align:right;"><?php echo '$' . number_format($total_batch_amount_invested, 2); ?></td>
                            <td style="font-size:10px;font-weight:bold;text-align:right;"><?php echo '$' . number_format($total_batch_charges, 2); ?></td>
                            <td style="font-size:10px;font-weight:bold;text-align:right;"><?php echo '$' . number_format($total_batch_commission_received, 2); ?></td>
                        </tr>
                    <?php } ?>
                    <tr style="background-color: #f1f1f1;">
                        <td style="font-size:10px;font-weight:bold;text-align:center;">Total Records: <?php echo $total_records; ?></td>
            ...
            <thead>
                <tr style="background-color: #f1f1f1;vertical-align: bottom;">
                    <th style="text-align:left;width:15%;font-weight:bold;">
                        <h5 style="    display: inline-block;">TRADE #</h5>
                        <h5 style="margin-left: 20px;display: inline-block;">DATE</h5>
                    </th>
                    ...
                    <th style="text-align:center;font-weight:bold;">
                        <h5>AMOUNT<br>INVESTED</h5>
                    </th>
                    <th style="text-align:center;font-weight:bold;">
                        <h5>COMM<br>EXPECTED<br>RECEIVED</h5>
                    </th>
                    <th style="text-align:center;font-weight:bold;width:30%;">
                        <h5>HOLD REASON<br>DATE RECEIVED</h5>
                    </th>
                    ...
                    foreach ($get_trans_data as $trans_main_key => $trans_main_data) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="font-size:10px;font-weight:normal;text-align:right;"><?php echo '$' . number_format($trans_data['invest_amount'], 2); ?></td>
                                <td STYLE="font-size:10px;font-weight:normal;text-align:right;"><?php echo '$' . number_format($trans_data['commission_received'], 2); ?></td>
                                <td STYLE="font-size:10px;font-weight:normal;text-align:center;"><?php echo $trans_data['hold_reason'] ?><br><?php if ($trans_data['commission_received_date'] != '0000-00-00') {
                                                                                                                                                    echo date('m/d/Y', strtotime($trans_data['commission_received_date']));
                                                                                                                                                } ?></td>
        ...
        <table border="0" cellpadding="1" width="100%">
            <thead>
                <tr style="background-color: #f1f1f1;">
                    ...
                    <td style="font-size:10px;width: 15%;text-align:center;font-weight:bold;">
                        <h5 style="font-size:10px;">CLIENT</h5>
                    </td>
                    <td style="font-size:10px;width: 20%;text-align:center;font-weight:bold;">
                        <h5 style="font-size:10px;">PRODUCT</h5>
                    </td>
                    <td style="font-size:10px;text-align:center;font-weight:bold;">
                        <h5 style="font-size:10px;">INVESTMENT AMOUNT</h5>
                    </td>
                    <td style="font-size:10px;text-align:center;font-weight:bold;">
                        <h5 style="font-size:10px;">COMMISSION RECEIVED</h5>
                    </td>
                    <td style="font-size:10px;text-align:center;font-weight:bold;">
                        <h5 style="font-size:10px;">CHARGE</h5>
                    </td>
                    <td style="font-size:10px;text-align:center;font-weight:bold;">
                        <h5 style="font-size:10px;">BROKER PAYOUT</h5>
                    </td>
                </tr>
            </thead>
            <tbody>
