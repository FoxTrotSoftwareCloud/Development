...
if(isset($_GET['filter']) && $_GET['filter'] != '')
{
    ...
    if($report_for == "company"){
        if($company > 0){
            ...
            $subheading.=" FOR ".strtoupper($name['company_name']);
            //$subheading.="\r Broker: (ALL Brokers), Client: (ALL Clients)";
        }
        else{
              $subheading.=" FOR ALL COMPANIES";
             // $subheading.="\r Broker: (ALL Brokers), Client: (ALL Clients)";
        }
    ...
    if($report_for == "broker"){
        if($broker > 0){
            ...
            $subheading.=" FOR ".strtoupper($name['last_name']).', '.strtoupper($name['first_name']);
    ...
    $sheet_data = array( // Set sheet data.
        ...
        array(
            ...
            'A4'=>array('TRADE #',array('bold','left','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
            'B4'=>array("TRADE DATE / SETTLE DATE" ,array('bold','left','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
            'C4'=>array("CLIENT / FILE #",array('bold','left','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'))),
        ...
        {   
            ...
            foreach($get_trans_data as $trans_main_key=>$trans_main_data)
            {
                     ...
                     $sheet_data[0]['A'.$i] = array("BROKER: ".$trans_main_data['broker'],array('bold','left','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'),'merge'=>array('A'.$i,'F'.$i)));
                    $i++;
                    foreach($trans_main_data['products'] as $trans_key=>$trans_data_product){    
                        ...
                        $sheet_data[0]['A'.$i] = array("PRODUCT: ".$trans_data_product[0]['product_name'],array('bold','left','color'=>array('000000'),'background'=>array('f1f1f1'),'size'=>array(10),'font_name'=>array('Calibri'),'merge'=>array('B'.$i,'F'.$i)));
                         $i++;
                         foreach($trans_data_product as $trans_key=>$trans_data){
                            ...
                            $sub_total_charges = ($sub_total_charges+$trans_data['charge_amount']);
                             $total_comm_received+=$trans_data['commission_received'];
                                ...
                                $sheet_data[0]['B'.$i] = array(date("m/d/Y",strtotime($trans_data['trade_date'])) ."\n" . date("m/d/Y",strtotime($trans_data['settlement_date'])),array('left','color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                           ...
                           $sheet_data[0]['C'.$i] = array("** PRODUCT SUBTOTAL **",array('center','background'=>array('f1f1f1'),'color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                           $sheet_data[0]['D'.$i] = array(number_format($sub_total_amount_invested,2),array('right','background'=>array('f1f1f1'),'color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                            $sheet_data[0]['E'.$i] = array(number_format($sub_total_commission_received,2),array('right','background'=>array('f1f1f1'),'color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                              $i++;
                ...
                $i++;
                 $sheet_data[0]['C'.$i] = array("*** REPORT TOTALS ***  ",array('center','background'=>array('f1f1f1'),'color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')),'merge'=>array('C'.$i,'D'.$i));
                 $sheet_data[0]['D'.$i] = array($instance->re_db_output('$'.number_format($total_comm_received,2)),array('center','background'=>array('f1f1f1'),'color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
                 $sheet_data[0]['E'.$i] = array($instance->re_db_output('$'.number_format($total_comm_paid,2)),array('center','background'=>array('f1f1f1'),'color'=>array('000000'),'size'=>array(10),'font_name'=>array('Calibri')));
