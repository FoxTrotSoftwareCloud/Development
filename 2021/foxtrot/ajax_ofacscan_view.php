...
<table border="0" width="100%">
    <tr>
        ...
        <?php } ?>
        <td width="60%" style="font-size:12px;font-weight:bold;text-align:center;"><?php echo $get_company_name['company_name']; ?></td>
        <?php
    ...
    <tr>
        <td width="100%" colspan="3" style="font-size:14px;font-weight:bold;text-align:center;">OFAC SPECIALLY DESIGNATED NATIONALS CLIENT CHECK </td>
    </tr>
    <tr>
        <td width="100%" colspan="3" style="font-size:12px;font-weight:bold;text-align:center;">File Date: <?php echo $file_date; ?>, Scanned: <?php echo $created_date; ?><?php ?></td>
    </tr>
</table>
<br />
<table border="0" cellpadding="1" width="100%">
    ...
    <tbody>
        ...
        ?>
                <tr>
                    <td style="font-size:10px;font-weight:normal;text-align:left;"><?php echo $val['sdn_name']; ?></td>
                    <td style="font-size:10px;font-weight:normal;text-align:center;"><?php echo $val['ent_num']; ?></td>
                    ...
                    <td style="font-size:10px;font-weight:normal;text-align:left;"><?php echo $val['client_name']; ?></td>
                    <td style="font-size:10px;font-weight:normal;text-align:center;"><?php echo $val['broker_id']; ?></td>
                    <td style="font-size:10px;font-weight:normal;text-align:left;"><?php echo $val['broker_name']; ?></td>
                </tr>
            <?php } ?>
            <tr style="background-color: #f1f1f1;">
