...
if ($report_for == "year_to_date") {
    ...
    if (!empty($rows) && !empty($rows['unique_category'])) {
        ...
        $html .= '<h5 style="font-size:17px;font-weight:bold;text-align:center;">Category Total</h5>
                <tr style="vertical-align: bottom;background-color: #f1f1f1;">
                <td class="modal-heading-row" align="right">PRODUCT CATEGORY </td>
                <td class="modal-heading-row" align="right">TOTAL INVESTMENT AMOUNT </td>
                <td class="modal-heading-row" align="right">TOTAL COMMISSION RECEIVED </td>
                <td class="modal-heading-row" align="right">TOTAL NET COMMISSION </td>
            </tr>
            ';
