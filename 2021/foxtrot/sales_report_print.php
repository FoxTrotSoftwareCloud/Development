...
if(isset($_GET['filter']) && $_GET['filter'] != '')
{
    ...
    $subheading="<br/>TRANSACTION BY ".strtoupper($report_for);
    ...
    if(!empty($get_trans_data))
    {
            ...
            foreach($get_trans_data as $trans_key=>$trans_data)
            {
                ...
                $trade_date= ($trans_data['trade_date'] != '0000-00-00') ? date('m/d/Y',strtotime($trans_data['trade_date'])) : "";
                $html.='<tr>
                      <td style="font-size:10px;font-weight:normal;text-align:left;">'.$trade_date.'</td>';
                if($report_for == "client") : 
            ...
            $html.='<tr style="background-color: #f1f1f1;">
                            ...
                            <td></td>
                             <td></td>
                            <td  style="font-size:10px;font-weight:bold;text-align:right;"><b>** TOTAL **</b></td>
