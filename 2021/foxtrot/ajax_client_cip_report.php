        ...
        <table border="0" width="100%">
            <tr>
                ...
                <td width="60%" align="center"><?php echo $img; ?> <br />
                    ...
                    <h6>Open Dates: <?php echo $trade_dates; ?></h6>
                    <h6>Broker: <?php echo $queried_brokers; ?>, Sponsor: <?php echo $sponsor_name; ?>,<?php echo " " . $cip_info  ?> </h6>
                    <?php echo ($exclude_donot_contact_client) ? "<h6>Excluding 'Do Not Contact' Clients</h6>" : "" ?>
                </td>
            ...
            <table>
                <thead>
                    <tr style="background:#f1f1f1;text-transform: capitalize;" style="width: 100%;">
                        <th style="padding: 8px 0px;font-size: 12px;width: 10%;">NAME</th>
                        <th style="padding: 8px 0px;font-size: 12px; width: 13%;">ADDRESS</th>
                        <th style="padding: 15px 0px;font-size: 12px; width: 7%;">CITY</th>
                        <th style="padding: 8px 0px;font-size: 12px; width: 7%;">STATE</th>
                        <th style="padding: 8px 0px;font-size: 12px; width: 7%;">ZIP CODE</th>
                        ...
                        <th style="font-size: 12px; width: 5%;">ID</th>
                        <th style="font-size: 12px; width: 7%;">TYPE</th>
                        <th style="padding: 8px 0px;font-size: 12px; width: 6%;">NUMBER</th>
                        <th style="padding: 8px 0px;font-size: 12px; width: 10%;">EXPIRATION DATE</th>
                ...
                <tbody>
                    ...
                    if ($is_recrod_found == false) { ?>
                        <tr>
                            <td style="font-size:12px;text-align:center; padding: 15px 5px;" colspan="14"><b>No Records Found.</b> </td>
                        </tr>
                    <?php }
                    ?>
