...
<table class="table table-bordered table-stripped table-hover">
    ...
    <?php foreach($get_notes as $key=>$val){
        ...
        <tr>
            ...
            <td>
            <form method="post" id="add_sponsor_notes_<?php echo $notes_id;?>" name="add_sponsor_notes_<?php echo $notes_id;?>" onsubmit="return notessubmit(<?php echo $notes_id;?>);">
                <input type="text" name="sponsor_note" class="form-control" id="sponsor_note" value="<?php echo $val['notes'];?>" style="pointer-events: none;"/>
    ...
    <tr id="add_row_notes" style="display: none;">
            ...
            <td>
            <form method="post" id="add_sponsor_notes_<?php echo $notes_id;?>" name="add_sponsor_notes_<?php echo $notes_id;?>" onsubmit="return notessubmit(<?php echo $notes_id;?>);">
                <input type="text" name="sponsor_note" class="form-control" id="sponsor_note" value=""/>
